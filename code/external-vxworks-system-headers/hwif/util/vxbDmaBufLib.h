...
--------------------
01t,11jun12,sye  Removed duplicate method declaration. (WIND00353762)
01s,29apr10,pad  Moved extern C statement after include statements.
01r,26feb10,h_k  added mapSyncPartFunc member in vxbDmaBufMap structure.
                 added vxbDmaBufFragFill().
                 added VXB_DMABUF_CACHESNOOP_BUS and
                 VXB_DMABUF_MEMALLOC_CLEAR_BUF.
01q,10feb10,h_k  added pBounceSaved in vxbDmaBufMap.
...
01p,04jan10,h_k  replaced FUNCPTR with fully qualified function pointer
                 parameters for mapXxx funcs.
01o,21sep09,h_k  added VXB_SPACE_MAXADDR macros.
01n,01sep09,h_k  added fragVirt to vxbDmaBufFrag.
                 changed the type of frag to UINT64.
01m,25mar09,h_k  added prototype for vxbDmaBufInit().
...
struct vxbDmaBufMap
    ...
    STATUS (*mapLoadFunc)(VXB_DEVICE_ID,
			  VXB_DMA_TAG_ID,
			  VXB_DMA_MAP_ID,
			  void *,
			  bus_size_t,
			  int);		/* parent bus load func */
    STATUS (*mapLoadMblkFunc)(VXB_DEVICE_ID,
			      VXB_DMA_TAG_ID,
			      VXB_DMA_MAP_ID,
			      M_BLK_ID,
			      int);	/* parent bus mBlk load */
    STATUS (*mapLoadIoVecFunc)(VXB_DEVICE_ID,
			       VXB_DMA_TAG_ID,
			       VXB_DMA_MAP_ID,
			       struct uio *,
			       int);	/* parent bus iovec load func */
    STATUS (*mapLoadIpcomFunc)(VXB_DEVICE_ID,
			       VXB_DMA_TAG_ID,
			       VXB_DMA_MAP_ID,
			       struct Ipcom_pkt_struct *,
			       int);	/* parent bus Ipcom_pkt load */
    STATUS (*mapUnloadFunc)(VXB_DEVICE_ID,
			    VXB_DMA_TAG_ID,
			    VXB_DMA_MAP_ID);
					/* parent bus unload func */
    STATUS (*mapSyncFunc)(VXB_DEVICE_ID,
			  VXB_DMA_TAG_ID,
			  VXB_DMA_MAP_ID,
			  bus_dmasync_op_t);
    STATUS (*mapSyncPartFunc)(VXB_DEVICE_ID,
			      VXB_DMA_TAG_ID,
			      VXB_DMA_MAP_ID,
                              off_t,
                              size_t,
