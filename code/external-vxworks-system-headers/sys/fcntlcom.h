...
/*
* Copyright (c) 1984-1999, 2005-2006, 2008, 2010 Wind River Systems, Inc.
*
...
-------------------- 
01n,28apr10,pad  Moved extern C statement after include statements.
01m,09apr10,lxj  change struct flock l_pid from int type to long type for LP64
01l,15sep08,jmp  added O_TEXT flag to allow opening a file in text translation
                 mode (CQ:WIND00119715).
01k,28jun06,jlk  added open mode flag, O_NOATIME
01j,17oct06,jlk  Fix WIND00069548. Added _FFD_CLOEXEC for POSIX
01i,14feb06,act  O_SYNC and variants are POSIX, should be outside #if test
01h,13feb06,act  POSIX fixes for struct flock
01g,12feb06,mil  Updated for POSIX namespace conformance (P2).
01f,18oct05,md   added FCNTRL flag
01e,01mar05,hya  added new defines to support POSIX compliance
01d,13dec99,jkf  added _ASMLANGUAGE
