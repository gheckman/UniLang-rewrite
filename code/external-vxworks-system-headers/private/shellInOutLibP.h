...
/* Defines */
#ifndef HOST
#define SHELL_OUTPUT_LOCK(shellId)	shellOutputLock (shellId)
#define SHELL_OUTPUT_UNLOCK(shellId)	shellOutputUnlock (shellId)
#else /* !HOST */
...
/* XXX bpn - define this function here because they are used by IMPORTal files */
