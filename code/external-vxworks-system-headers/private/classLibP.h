...
/*
 * Copyright (c) 2004-2005, 2007-2010, 2012 Wind River Systems, Inc.
 *
...
--------------------
01z,09jul12,wzc  WIND00361531 - Remove building warnings.
01y,13oct10,jpb  Fixed wrong offset listed in comments of OBJ_CLASS struct
01x,16aug10,cww  Use dynamically generated offsets in offset macros
01w,29apr10,pad  Moved extern C statement after include statements.
01v,23jan10,gls  modified handle size
01u,17feb09,zl   changed to fully qualified function pointers. LP64 updates.
01t,20oct08,jpb  Defect 139482.  Renamed VX_CLASS_TASK_LIST_LOCK 
                 and VX_TASK_CLASS_LIST_UNLOCK to 
		 VX_CLASS_LIST_LOCK and VX_CLASS_LIST_UNLOCK.
01s,27aug08,jpb  Renamed VSB header file
01r,30jul08,jpb  Added macros for common code and support when class list 
                 configuration is removed.
01q,26jan07,zl   added class list management function pointer types
...
typedef void	(*CLASS_LIST_REMOVE_FUNC)	(OBJ_CORE * pObjCore,
						 CLASS_ID classId);
typedef void	(*CLASS_LIST_TBL_INIT_FUNC)	(void);
...
extern CLASS_LIST_TBL_INIT_FUNC _func_classListTblInit;
