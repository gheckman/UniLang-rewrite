...
/*
 * Copyright (c) 2003, 2004, 2006, 2009-2012 Wind River Systems, Inc.
 *
...
--------------------
01i,31aug12,jmp  Re-introduced a COPROCS_ALL macro to avoid backward
		 compatibility issue when rebuilding a project created for
		 a release older than 6.9.2.2.
01i,15may12,jmp  CQID: Fix WIND00309977 : Removed obsolete COPROCS_ALL macro.
01h,02nov11,swu  add _func_fppTaskRegsShow. (WIND00245382)
01g,28jun10,jc0  add protoTypes in coproLibP.h header file (WIND00211499).
01f,29apr10,pad  Moved extern C statement after include statements.
01e,17sep09,cww  Use fully qualified pointers in COPROC_DESC
01d,28may09,cww  Add LP64 support
01c,31aug06,zl   Removed pLastTask from COPROC_DECS and added pLastEntry
