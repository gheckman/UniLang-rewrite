...
/*
 * Copyright (c) 2003-2005, 2007, 2010, 2012-2013 Wind River Systems, Inc.
 *
...
--------------------
01s,15may13,cww  Extended isInSigHandler() from sigLibP.h (WIND00417069)
01r,29jun12,jpb  Finished merge for Defect WIND00307800.
01q,29feb12,jpb  Defect WIND00307800.  Updated RTP_SIG_CTX structure to 
                 maintain ucontext_t info.
01p,01sep10,jpb  Added function pointer _func_rtpTaskSigCheck.
01o,02mar10,cww  LP64 adaptation
01n,17sep07,gls  moved public APIs to rtpLib.h (Defect #00102843)
...
extern int (*_func_rtpTaskSigPendKill) (WIND_TCB * tid,
...
extern OBJ_HANDLE rtpChildHandleGet  (RTP_ID rtpId);
extern RTP_ID     rtpChildIdGet      (OBJ_HANDLE pHandleId);
extern RTP_ID     rtpChildWait       (RTP_ID childRtpId,
                                      OBJ_HANDLE * pHandleId,
