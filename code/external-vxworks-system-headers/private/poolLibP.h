...
/*
 * Copyright (c) 1998, 2003-2005, 2007-2011 Wind River Systems, Inc.
 *
...
--------------------
01q,01feb11,cww  Added freeCount to pool structure (WIND00247578)
01p,17sep10,gls  made VX_POOL kernel only
01o,28jun10,pad  Made so that _WRS_CONFIG_MEM_ALLOT option applies to the
                 kernel environment only.
01n,28apr10,pad  Moved extern C statement after include statements.
01m,16dec09,zl   declare VX_POOL unconditionally, for small footprint
                 VxWorks configuration as well.
01l,14sep09,zl   added poolInitialize()
01k,01apr09,jpb  Replaced lstLib with dllLib.
01k,27may09,x_s  Wrapped some code with vsb option _WRS_CONFIG_MEM_ALLOT and 
...
01g,12feb07,jmg  Added declaration of poolLibInit().
