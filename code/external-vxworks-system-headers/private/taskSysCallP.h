...
--------------------
01c,20aug10,gls  modified VX_TASK_CTL_DELETE command (WIND00216710)
01b,17jun10,jpb  Changed stackGuardSize type from ssize_t to size_t
01a,22jan10,cww  Written
*/
