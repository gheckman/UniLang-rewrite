...
--------------------
01w,29apr10,pad  Moved extern C statement after include statements.
01v,23feb10,v_r  Moved to fully qualified function pointers.
01u,22feb10,v_r  LP64 TODOS cleanup. 
01t,08jan10,v_r  Added 64-bit byteswapping macros and host read/write routines
		 (latter untested).
01t,03feb10,rlp  Defined syncLoadRtn as fully qualified function pointer.
01s,16jun09,v_r  LP64 adaptation:: added MEM_WRITE_64 macro and updated
		 ALIGN_NEXT.
01r,04jun09,v_r  LP64 adaptation: updated loadCommonSymbolProcess() to use
		 ULONG for symbol alignement and size.
01q,30apr09,v_r  LP64 adaptation (phase #1) : updated code following adaptation
...
01p,17apr09,zl   unconditionalized ALIGN_NEXT definition
01o,30apr08,v_r  Network symbol table special flags handling now done in
                 loader code.
01n,16apr08,v_r  Added macros to perform unaligned writes (def
                 CQ:WIND00120849).
01m,03jul07,p_b  Avoid build warning by renaming locally used SWAB_16() macro
01l,12jul06,dbt  Removed use of tgtMemManyWrite() that has been obsoleted.
01k,18jan06,v_r  Added pointers for loader/unloader hook facility.
