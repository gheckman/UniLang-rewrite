...
01d,04sep13,jxu  turned off debug. 
01c,20jun13,jxu  supported finer control over the debug log 
01b,30nov12,jxu  added endian conversion macros.
01a,10aug12,jxu  written.
*/
...
_ftl_inline BOOL bmpTest (UINT8 * addr, UINT32 bitPos); 
_ftl_inline BOOL bmpIsAllClear (UINT8 * addr, UINT32 length); 
_ftl_inline void bmpSet (UINT8 * addr, UINT32 bitPos); 
_ftl_inline void bmpClear (UINT8 * addr, UINT32 bitPos); 
_ftl_inline int bmpFfsLsb (UINT8 * addr, UINT32 length); 
_ftl_inline int bmpFfsLsbHint (UINT8 * addr, UINT32 length, UINT32 hintPos); 
