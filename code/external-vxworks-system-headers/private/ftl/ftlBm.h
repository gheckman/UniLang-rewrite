...
--------------------
01e,11oct13,ghs  Correct compile error (WIND00438400)
01d,08jun13,jxu  added ftlBmCopy to help copy pages for gc/wl/bbm 
                 added a block mark for bbm to identify runtime bad blocks
01c,08nov12,jxu  added more device geometry info to bm identity.
01b,01sep12,jxu  rewritten for conceptual integrity.
01a,15may12,x_z  created.
*/
...
extern __inline__ MTD_DESC * ftlFindMtd (FTL_BM_DESC * pBm, fblock_t blkNo);
