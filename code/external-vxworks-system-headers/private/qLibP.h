...
--------------------
01g,19jan11,gls  added qPriDelta prototypes (WIND00200778)
01f,17may10,kk   added QUEUE_KERNEL_INTERRUPTIBLE for (WND00193764)
01f,29apr10,pad  Moved extern C statement after include statements.
01f,29apr10,pad  Moved extern C statement after include statements.
01e,01oct09,zl   removed qInit()
01d,20feb09,zl   changed advanceRtn nTicks argument to ULONG.
01c,17feb09,zl   included vsbConfig.h, fixed Q_PRI_NODE_KEY definiton.
01b,11feb09,zl   moved queue class definitions from public header files
01a,27aug08,zl   created.
*/
...
#define QUEUE_ATTRIBUTE_MASK          0x03
