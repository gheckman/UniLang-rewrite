...
/*
 * Copyright (c) 2001,2003-2005, 2009-2010,2013 Wind River Systems, Inc.
 *
...
--------------------
01j,24jun13,elp  Replaced mutex with RW semahore, added symEachCall()
		 (CQ:WIND00409243).
01i,29apr10,pad  Moved extern C statement after include statements.
01h,22jun09,jmp  Moved symLib function pointers from funcBindP.h.
01g,23feb09,jmp  64-bit support: Used new symbol types.
