...
--------------------
01s,24aug11,zl   added SD state for SMP, moved reference counting 
                 code directly to sdLib.
01r,22feb10,jpb  Updated for LP64 adaptation.
01q,18may09,jmp  Added missing sdClassId and sdShow()
...
01n,11may07,pcs  Remove macro SD_DEFAULT_CACHE_COHERENCY, since SD lib now
                 uses VM_DEFAULT_CACHE_COHERENCT_ATTR.
01m,23apr07,pcs  Move SD_LOCK & SD_UNLOCK to sdLib.c
01l,07jul05,zl   embedded semaphore in SD structure.
...
#define SD_UNLOCK(sdId)         semGive(&(sdId)->sem)
