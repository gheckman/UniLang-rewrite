...
/* 
 * Copyright (c) 1984-1997, 2006, 2008-2010, 2012-2013 Wind River Systems, Inc. 
 *
...
--------------------
02z,15may13,cww  Moved isInSigHandler() to rtpSigLibP.h (WIND00417069)
02y,19apr13,cww  Added pSigContext field to sigtcb (WIND00408461)
02x,21jun12,pad  Moved the definition of the sigcontext type to signal.h since
		 this type is documented (defect 315689).
02w,16jun10,pcs  change the data type of timeout from an int to _Vx_ticks_t
02v,29apr10,pad  Moved extern C statement after include statements.
02u,06apr10,jpb  Updated sigpend struct.
02t,10sep09,cww  LP64 adaptation
