...
--------------------
01h,13aug10,cww  Use dynamically generated offsets in offset macros
01g,17may10,cww  LP64 adaptation
01f,17sep08,gls  added _WRS_KERNEL_LOCK_OFFSET_ assembly offsets 
                 (Defect #1240649)
01e,03sep07,mmi  Turn-off KERNEL_LOCK_TRACE
01d,18apr07,mmi  add KERNEL_LOCK_TRACE to kernelLockTry
01c,01mar07,v_r  Added kernelLockOwnerGet() prototype API for req
                 CQ:WIND00088695).
01b,04dec06,pes  Implement kernel lock tracing facility.
