...
--------------------
01h,22oct12,x_z  added Flash usage type.
01g,22sep12,x_z  changed column address from UINT16 to UINT32 for NOR Flash;
                 changed type of uLen of FLASH_SGBUF_T type;
                 updated FLASH_CELL_T.
01f,19sep12,x_z  adjusted general address defines for NAND Flash.
01e,18sep12,jxu  integration with FTL.
01d,03sep12,x_z  added private information for scatter-gather buffer;
                 added Flash bad block descriptor define
01c,20aug12,x_z  fixed compatibility issue with old Flash type defines.
01b,07aug12,x_z  updated scatter-gather buffer interface.
01a,31jul12,x_z  created.
*/
