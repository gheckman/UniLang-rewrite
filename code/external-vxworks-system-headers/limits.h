...
/*
 * Copyright (c) 1992-2005, 2009-2013 Wind River Systems, Inc.
 *
...
--------------------
01r,27sep13,dee  correct value of LLONG_MIN  WIND00436891
01q,13jan12,pad  Set SSIZE_MAX appropriately depending on the data model
                 (defect 315132).
01p,19dec11,jpb  Defect 00145128.  Added SEM_VALUE_MAX and SEM_NSEMS_MAX.
                 Increased value of SEM_VALUE_MAX from 100 to 32767 and
                 SEM_NSEMS_MAX to 256.
01o,30mar10,pad  Moved declaration of extern C block for C++ after the
                 inclusion of header files.
01n,05mar09,zly  remove PIPE_BUF(WIND00088829)
01m,24oct05,md   changed PATH_MAX count to include null terminator
01l,02aug05,kk   added DELAYTIMER_MAX
01k,04jul05,hya  Added more macros.
01j,01mar05,gls  added _POSIX macros definitins from time.h (SPR #105358)
01i,05may04,pad  set NGROUPS_MAX and SSIZE_MAX to, respectively,
