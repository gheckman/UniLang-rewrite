...
/*
 * Copyright (c) 1984-2010,2012 Wind River Systems, Inc.
 *
...
--------------------
04k,09may12,dee  Fix typo added when WIND00212450 was fixed by WIND00327558
04j,09jan12,pgh  Add comments to flags
04i,03may10,h_k  changed sysInLong() return val for LP64.
04h,29apr10,pad  Moved extern C statement after include statements.
04g,20jan10,dbt  Added sysUserSmInfoGet() VxSim specific routine.
04f,21sep09,cww  Added sysHwInit1
04e,03sep09,scm  add MEM_DESC_ADDR_KERNEL_ASSIGNED...
04d,24aug09,sru  add sysMemDesc* feature
04c,23oct08,kab  Update sysAmpCpuPrep to new sig per design mod
04b,15oct08,kab  Adding sysSymPhysMemBottom/Size (wrload and hv support)
04a,06jun08,pgh  Merge DHCP fixes
03z,13jul07,kk   remove _WRS_VX_SMP usage, added sysCpuAvailableGet()
03y,08mar06,lei  removed __STDC__ stuff.
03x,25may05,md   added SMP support
