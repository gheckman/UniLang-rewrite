...
/*
 * Copyright (c) 2004 - 2006, 2008, 2011-2012, 2014 Wind River Systems, Inc.
 *
...
--------------------
01s,28feb14,yjl  Fix VXW6-80644, nfs v3 will support new function FIOLINK.
01r,21feb14,xwu  fix VXW6-73531 NFSV3 CLIENT : O_EXCL does not work in
                 combination with O_CREAT
01q,14sep12,yjl  Fix WIND00376255, dosFs to be compatible with Windows FAT32
                 naming rules for file/directory name length
01p,06aug12,txu  Fix WIND00367917: NFS v3 client does not support READDIRPLUS
01o,29jun12,txu  fix WIND00356231: UNSTABLE write is not working for the NFS 
                 client with the haneWin NFS server 
01n,21jun11,sjz  Improve NFS performance for the requirement WIND00236547.
01m,29apr10,pad  Moved extern C statement after include statements.
01l,09sep08,lyc  fix WIND00132892
01k,07sep06,mwv  update include paths
01j,18apr06,pcm  added support for chmod()
01i,22mar06,pcm  fixed SPR 119426--invalidating client cache on NFSERR_STALE
01h,23jan06,pcm  added nfs3StableWriteGet() and nfs3StableWriteSet()
01g,20jan06,md   added pathconf support
01f,19dec05,pcm  re-arranged structure of NFS3_FD
01e,07dec05,pcm  changed structure of NFS3_FD
