...
02i,22sep06,mze  removed SM_MAX_PKTS (WIND00058841)
02h,17mar05,bwa  added smPktAttachTo(), smPktSetupInst().
02g,31aug04,bwa  moved DEFAULT_CPUS_MAX to smLib.h (SPR97418).
02f,11mar02,mas  added SM_MAX_PKTS (SPR 73371)
