...
--------------------
01b,11oct13,ghs  Correct compile error (WIND00438400)
01a,29feb12,jxu  written.
*/
...
#define _ftl_inline  extern __inline__
...
IMPORT __inline__ void * ftlMemAlloc (size_t nBytes);
IMPORT __inline__ int ftlMemFree (char * pMem);
IMPORT __inline__ void * ftlCacheDmaMalloc (size_t nBytes);
IMPORT __inline__ int ftlCacheDmaFree (char * pMem);
IMPORT __inline__ FTL_ATOMIC32_T ftlAtomic32Inc (FTL_ATOMIC32_T * pVar);
IMPORT __inline__ FTL_ATOMIC32_T ftlAtomic32Dec (FTL_ATOMIC32_T * pVar);
IMPORT __inline__ FTL_ATOMIC32_T ftlAtomic32Clear (FTL_ATOMIC32_T * pVar);
IMPORT __inline__ FTL_ATOMIC32_T ftlAtomic32Get (FTL_ATOMIC32_T * pVar);
IMPORT __inline__ FTL_ATOMIC32_T ftlAtomic32Set (FTL_ATOMIC32_T * pVar, 
            FTL_ATOMIC32_T value);
IMPORT __inline__ FTL_ATOMIC32_T ftlAtomic32Add (FTL_ATOMIC32_T * pVar, 
            FTL_ATOMIC32_T value);
IMPORT __inline__ FTL_ATOMIC32_T ftlAtomic32Sub (FTL_ATOMIC32_T * pVar, 
            FTL_ATOMIC32_T value);
IMPORT __inline__ FTL_ATOMIC64_T ftlAtomic64Get (FTL_ATOMIC64_T * pVar); 
IMPORT __inline__ FTL_ATOMIC64_T ftlAtomic64Set (FTL_ATOMIC64_T * pVar, 
            FTL_ATOMIC64_T value);
IMPORT __inline__ FTL_ATOMIC64_T ftlAtomic64Add (FTL_ATOMIC64_T * pVar, 
            FTL_ATOMIC64_T value);
IMPORT __inline__ FTL_ATOMIC64_T ftlAtomic64Sub (FTL_ATOMIC64_T * pVar, 
            FTL_ATOMIC64_T value);
IMPORT __inline__ FTL_TASK_T ftlTaskCreate (char * name, int priority,
            int options, size_t stackSize, FUNCPTR entryPt,
            FTL_USR_ARG_T pArg);
IMPORT __inline__ int ftlTaskDelete (FTL_TASK_T taskId);
IMPORT __inline__ FTL_SEM_T ftlSemMCreate (int options);
IMPORT __inline__ FTL_SEM_T ftlSemCCreate (int options, int initCnt);
IMPORT __inline__ FTL_SEM_T ftlSemBCreate (int options, int initStat);
IMPORT __inline__ int ftlSemDelete (FTL_SEM_T semId);
IMPORT __inline__ int ftlSemTakeTry (FTL_SEM_T semId);
IMPORT __inline__ int ftlSemTake (FTL_SEM_T semId, FTL_TICK_T ticks, int flags);
IMPORT __inline__ int ftlSemGive (FTL_SEM_T semId);
IMPORT __inline__ int ftlSysClkRateGet (void);
IMPORT __inline__ FTL_TICK_T ftlTickGet (void);
IMPORT __inline__ int ftlSetErrno (int errNo);
