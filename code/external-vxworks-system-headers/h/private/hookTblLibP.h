...
--------------------
01b,27nov12,jpb  fixed value of HOOK_TABLE_STATUS_BITS (WIND00392252)
01a,27apr12,cww  written
*/
...
#define HOOK_TBL_READ_RESERVE(pReservedTable,pHookTable)		    \
    ...
    vxAtomic32Inc (&(pHookTable)->execCnt);				    \
...
#define HOOK_TBL_READ_UNRESERVE_NO_UNPEND(pHookTable)			\
    ...
    if (vxAtomic32Dec (&(pHookTable)->execCnt) == 1)			\
	{								\
	vxAtomicAnd ((atomic_t *) &(pHookTable)->pActiveTable,		\
		     ~HOOK_TABLE_STATUS_BITS);				\
	}								\
    }
