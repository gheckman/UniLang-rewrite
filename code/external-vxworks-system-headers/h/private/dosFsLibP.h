...
/*
 * Copyright (c) 1984-2007, 2009-2013 Wind River Systems, Inc.
 *
...
--------------------
02t,20nov13,ghs  Merge continuous trim block (WIND00439644)
02s,10oct13,ghs  Expand _PARM_PATH_MAX to be compatible with Windows FAT32
                 (WIND00438274)
02r,31jan13,xwu  Fix WIND00399652 dosFsCacheCreate() user shall be able to define
                 smaller cache size
02q,30jan13,ghs  Add a link node field for DOS_CACHE_DESC (WIND00395472)
02p,25sep12,zly  Change invlBlks and dirtyBlks to int from short type.
                 (WIND00365563)
02p,14sep12,yjl  Fix WIND00376255, dosFs to be compatible with Windows FAT32
                 naming rules for file/directory name length.
02o,10aug12,yjl  Fix defect WIND00364508, To get correct block size from disk
                 and not always uses 512
02n,13may11,yjl  Fix defect WIND00259953, dosFs: moving directory creates
                 bogus directory entries
02m,27jul10,sjz  fix defect WIND00224526, upgrade tiny cache for high performance
02l,18may10,yjl  manually merge from 6.8.1 to 6.9
02l,29apr10,pad  Moved extern C statement after include statements.
02k,21apr10,yjl  fix defect WIND00208806
02j,01feb10,hps  fix WIND00198472
02i,18jan10,hps  replace semTake stateMtx with spinLock and modify default
                 values for BLOCKS_PER_DATA_DIR_CACHE_GROUP and FS_SETSIZE
02u,27oct09,yjl  fix for FS_NFDBITS define, fsMask in place of fd_mask
02t,23oct09,yjl  manually merge release6_7-64bit
02t,03aug09,hps  requirement WIND00142043, group cache with background flush
02s,29jul09,yjl  remove warning about howmany
02r,22jul09,yjl  requirement WIND00142043
02q,08jul09,zly  remove macro "DOS_VOLUME_BIO_BUFFER_SIZE"(WIND00161794)
02p,04jun09,yjl  check in for performance WIND00142043 DOSFS Performance
02o,20aug07,jlk  WIND00100989: Added dirty count.
02n,29jun07,act  WIND00096598: rename can detach directories
02m,03may07,pcm  added 'readOnly' field to volume descriptor
02l,17jan07,act  add discard-interface discovery
02k,25oct06,pcm  made changes for DosFS Cache
02j,21aug06,pcm  added extern VOIDFUNCPTR's
02i,03mar06,dcc  fixed SPR 117527
02h,23jan06,dcc  optimized backwards seeks.
02g,12oct05,dcc  implemented non DMA-safe option for dosFs cache.
02f,29sep05,dcc  implemented write cache.
02e,04aug05,dcc  added more cache statistics data.
02d,04aug05,jlk  moved formatter function pointer, dosFsFmtRtn, to dosFsLib.h
02c,18jul05,jlk  Added formatter function pointer, dosFsFmtRtn
02b,07apr05,dcc  added cache support to dosFs.
02a,18apr05,dcc  updated dosFs formatter.
01z,30mar05,dcc  updated to use several bios per volume.
01y,31jan05,dcc  modified to use XBD interface.
01x,07oct04,act  split flags and mode in pathLkup function
01w,26aug04,feg  Coverity code coverage bug #261 of 2004-06-22
01v,18apr04,act  add Unicode; change (and document) chkdsk semi-secret info
01u,04apr04,jkf  SPR#95752: changing openMode from u_char to u_int
01t,21mar04,act  changes to support clean bit
01s,04mar04,act  fix spelling in comments, type of parDirStartCluster
01r,02sep03,jkf  add volWriteOpt to DOS_VOLUME_DESC for write-through support.
...
IMPORT int dosFsDicard(DOS_VOLUME_DESC * pVolDesc, SECTOR_RANGE * range,
                       BOOL flush);
