...
/* 
 * Copyright (c) 1999-2005,2007-2010 Wind River Systems, Inc. 
 *
 *
...
--------------------
01p,05nov10,zl   removed pgMgrPhysToVirt and pgMgrVirtToPhys
01o,27apr10,pcs  Updated API's pgMgrPageUnmap and pgMgrPageFree to take an 
                 additional parameter option.
01o,29apr10,pad  Moved extern C statement after include statements.
01n,14apr10,zl   added _func_pgMgrOverlapIterate
01m,11jan10,zl   added growRtn to page manager.
01l,24jun09,zl   replaced lastVirtAddr with lastOverlapNode
01k,07apr08,pcs  update for discontiguous overlapped memory support.
01j,29mar07,pcs  change numPagesMapped to type atomic_t.
01i,07sep05,zl   added numPagesMapped to PAGE_MGR_OBJ.
01h,27jun05,zl   cleanup based on new adrSpaceLib APIs.
