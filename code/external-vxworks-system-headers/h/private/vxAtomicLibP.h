...
--------------------
01h,28jun10,pad  Allow inclusion of vsbConfig.h for RTP environment.
01g,28apr10,pad  Moved extern C statement after include statements.
01f,27jul09,cww  Changed vxCas to vxAtomicCas
01e,27aug08,jpb  Renamed VSB config file.
01d,24jun08,jpb  Added include path for kernel configurations options set in
                 vsb.  Renamed _WRS_VX_SMP to _WRS_CONFIG_SMP.
01c,07mar08,to   fix _WRS_ATOMIC_GET() for UP
01b,30aug07,kk   added VX_ATOMIC_OP_OPTIMIZED
01a,01aug07,jmg  Created.
*/
...
/* option bit for optimized atomic operators */

#define VX_ATOMIC_OP_OPTIMIZED 0x00000001
