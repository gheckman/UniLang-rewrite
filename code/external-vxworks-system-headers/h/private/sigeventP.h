...
/*
 * Copyright (c) 2003, 2006, 2009-2011 Wind River Systems, Inc.
 *
...
--------------------
01f,30nov11,jpb  WIND00309548.  sigeventUserToKernel possibly dereferences NULL
                 pointer.  Fixed build warning.
01e,28jan11,gls  added sigeventUserToKernel() (WIND00252562)
01d,04mar10,cww  LP64 adapatation
01c,23dec09,jpb  Updated for LP64 adaptation.
01b,10jul06,gls  added the sigeventLibInit() prototype
                 updated copyright
...
_WRS_INLINE struct sigevent * sigeventUserToKernel 
	...
	*pKSigev = *pUSigev;
	...
	pKSigev->sigev_notifier_id = 
	    (void *) objHandleToObjId ((OBJ_HANDLE) (long) pUSigev->sigev_notifier_id,
				       0, FALSE);
