...
01e,18sep09,pmr  add VSCR definitions
01d,01jun06,pch  consolidate vector offset definitions in excPpcLib.h
01c,21feb05,asa  Fix SPR#102393: removed #if def 0 around altivec register
		 tables
