...
/* 
 * Copyright (c) 1994-2005,2009 Wind River Systems, Inc. 
 *
...
--------------------
01h,14dec09,pgh  Add EM_ARCH_MACHINE_x macro definition.
01g,25jul05,v_r  Updated copyright.
01f,18sep04,jn   Move towards shared code between host and target loaders
01e,12jul04,jn   Source sanitization
01d,12apr04,jn   Cleaning up header files after merge of AE loader work into
                 Base 6
01e,08mar04,pad  Renamed the relocation type R_PPC_PLT24 into R_PPC_PLTREL24
		 to match the ABI.
01d,27feb04,pad  Renamed relocation type R_PPC_SDAREL into R_PPC_SDAREL16 to
		 match ABI.
