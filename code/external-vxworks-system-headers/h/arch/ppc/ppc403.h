...
/*
 * Copyright (c) 1984-2009, 2012 Wind River Systems, Inc.
 *
...
--------------------
01z,13apr12,cww  added common ESR bit definitions
01y,14jan09,to   define _WRS_CONFIG_PPC_CACHE_MODE_IS_CONSISTENT as 1
01x,31aug08,pch  change _PPC_CACHE_MODE_IS_CONSISTENT to
		 _WRS_CONFIG_PPC_CACHE_MODE_IS_CONSISTENT for VSB
01w,08apr08,pch  define _PPC_CACHE_MODE_IS_CONSISTENT since 403 has no
		 supported MMU
01v,16jul07,pch  CQ86377: re-enable MSR[FP] for syscall handler if enabled in
		 caller
01u,29jun07,pch  CQ96747: rename _PPC_MSR_MMU_EXTRACT macro
01t,06jul06,pch  add MSR bit definitions & use in INT_MASK
01s,12feb04,jtp  Add _WRS_MMU_CLASS_* macro
01r,05dec03,jtp  Add _WRS_TLB_MISS_CLASS_HW, _PPC_MSR_MMU_EXTRACT
01q,13mar03,pch  Add PPC32 support
...
#define	_PPC_MSR_BIT_PE		28
#define	_PPC_MSR_BIT_PX		29
...
#define	_CPU_CACHE_ALIGN_SIZE	16	/* cache line size */
...
/* These are the names used in the common exception handling */

#define _PPC_ESR_PIL	_PPC403_ESR_PEIM
#define _PPC_ESR_PPR	_PPC403_ESR_PEPM
#define _PPC_ESR_PTR	_PPC403_ESR_PETM
