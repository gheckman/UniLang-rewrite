...
--------------------
02j,03dec12,pcs  Decouple macro PPC_e500mc for e6500 core.
02i,03may11,syt  add support for PPC465.
02h,09oct10,x_z  add support for PPC476.
02g,26apr10,pmr  add L1CSR2 funcs
02f,10seo09,x_z  add vxSvrGet()
02e,20nov08,pmr  remove vxHid1Get/Set for e500mc
02d,04sep08,pmr  e500mc hard float
02c,13jun07,mmi  import vxIctcSet() and vxIctcGet(), vxC1StateSet(), removed
		 deprecated API, added copyright notice
02b,02may07,dcc  added declaration of vxSdaSet().
02a,26oct06,to   SMP: moved vxCpuIndexGet to vxCpuLib.h
01z,24aug06,to   SMP: added vxCpuIndexGet
01y,09jun04,rec  add 32-bit access routines for PPC970 HID registers
01x,22apr04,to   delete K&R prototypes.
01w,18mar04,rec  PPC970 merges
01v,25mar04,dtr  Add vxIvor1Set.
01u,31mar03,dtr  Adding vxHid1Set function.
01t,12nov02,mil  Updated support for PPC85XX.
01s,02aug02,pcs  Add support for PPC85XX and make it the same as PPC603 for
                 the present.
...
#if (CPU == PPC603) || (CPU == PPC604) || (CPU == PPC85XX)
...
#else	/* CPU == PPC440, PPC85XX, PPC476 , PPC465 */
