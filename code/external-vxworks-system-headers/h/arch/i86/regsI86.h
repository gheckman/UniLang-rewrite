...
/*
 * Copyright (c) 1992-1995, 1997-1998, 2001-2006, 2010-2013
...
--------------------
02d,27jun13,scm  WIND00421144 - correct for when Intel 64 Arch extensions not 
                 supported...
02c,09jan13,scm  WIND00229494 - SMP dedicated segment register
02b,07nov12,scm  WIND00376020 - fast system call support...
02a,19jan11,ggm  Implemented XSAVE/XRSTOR to manage YMM state.
01z,22oct10,jjk  Fix for WIND00196286 - MTRR overflow problem
01y,28apr10,pch  add CPUID_CHUNKS_TO_BYTES_SHIFT
01x,29mar10,jb   Add entry to WIND_CPU_STATE for AMP/SMP M-N
01w,09nov06,scm  adjust definitions for embedding CTX_SET structure into
		 WIND_TCB...
01v,28sep06,scm  Add declaration of WIND_CPU_STATE.
01u,21jul06,scm  Move SMP macros to private header.
01t,28jun06,scm  SMP GDT support.
01s,27jun06,scm  Add SMP support.
01r,12nov05,jln  Moved WIND_TCB_CTXSET to taskLibP.h
01q,11aug05,mmi  update CTX_SET .
01p,10mar05,kk   updated WIND_TCB_CTXSET since WIND_TCB has been updated
01o,21apr04,scm  add TASKGATE typedef...
01n,09mar04,jb   Rename PAD
01m,17dec03,jb   Adding reference to PAD in TCB
01l,02aug03,pes  Rename REG_PC macro as REG_SET_PC.
...
typedef struct wind_cpu_state
    {
    REG_SET     regs;
    BOOL        ampBoot;        /* Flag to indicate boot AMP/SMP M-N image */
    } WIND_CPU_STATE;
...
typedef struct taskGate         /* task gate */
    {
    UINT16      reserved1;      /* reserved1 15:00 */
    UINT16      selector;       /* TSS segment selector 31:16 */
    UCHAR       reserved2;      /* reserved2 07:00 */
    UCHAR       type;           /* P, DPL, S, Type 15:08 */
    UINT16      reserved3;      /* reserved3 31:16 */
    } TASKGATE;
...
#define CTX_SET_SIZE 16     /* sizeof(CTX_SET) */
...
#define CR4_OSXSAVE     0x00040000      /* use xsave/xrstor instructions */
...
#define	SEG_DATA_RW_EU          0x00000300	/* expand-up, read, write */
...
#define	SEG_CODE_ER_NC		0x00000b00	/* exec, read, non-conforming */
...
#if (CPU != PENTIUM)
#if  (CPU == PENTIUM4)
#define GDT_ENTRIES             11
#define GDT_KV_INDEX            10     /* GDT entry index for vxKernelVars */
#define GDT_KV_OFFSET           0x50   /* GDT entry offset for vxKernelVars */
#else
