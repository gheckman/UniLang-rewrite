...
--------------------
01u,27may10,pad  Moved extern C statement after include statements.
01s,27jan10,v_r  Added BE-8 ELF header flag (req CQ:WIND00213215, merged from
		 iter14_bsp_cortex_a9be8).
01t,10jun09,v_r  Fixed misleading comment.
01s,12may09,v_r	 Added ELF64 support (from Professional Services EMT64 Data
		 Access project).
01r,09jan09,v_r  Updated with newest ELF definitions (def CQ:WIND00122287).
01q,07jun06,jpb  Updated for POSIX namespace conformance.  Changed C
