...
--------------------
01q,29dec14,lan  Use OS_CONVERT_MILLISECONDS_TO_WAIT_VALUE to set semTake
                 timeout value (VXW6-83914) 
01p,01sep14,lan  add a semaphore to protect the usb2EndUnbind (VXW6-83171)
01o,10aug11,s_z  Replace netPoolInit by endPoolCreate (WIND00286518)
01n,18jul11,s_z  Deal with the network packet which has PAD data at the end
                 (WIND00288104)
01m,06jul11,ghs  Use USBD match function for matching device ID (WIND00183500)
01l,07jan11,ghs  Clean up compile warnings (WIND00247082)
01k,29apr10,pad  Moved extern C statement after include statements.
01j,27apr10,j_x  Import usb2EndIoctl for usbGen2Show (WIND00184395)
01i,30mar10,w_x  Back port GEN2 class drivers for old VxWorks (WIND00192167)
01h,23mar10,j_x  Changed for USB debug (WIND00184542)
01g,13jan10,ghs  vxWorks 6.9 LP64 adapting
01f,21oct09,w_x  Modifications for Kernel API references (WIND00187268)
...
01c,19aug09,s_z  Change usb2EndLoad routine as an external interface
...
#define USB2_END_DEFAULT_TIMEOUT                1000 /* millisecond */
#define USB2_END_DEFAULT_TIMEOUT_PLUS           2000 /* millisecond */
