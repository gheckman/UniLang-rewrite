...
/*
 * Copyright (c) 2001, 2003-2006, 2008-2012, 2014 Wind River Systems, Inc.
 *
...
02nov12,rec  WIND00368368 fix THUMB symbol reference
...
#else	/* _VX_CPU_FAMILY != _VX_ARM && _VX_CPU_FAMILY != _VX_SH && _VX_CPU_FAMILY != _VX_PENTIUM */
#define _WRS_ABSOLUTE_(name,value) \
        __asm__ (".globl\t"#name \
                "\n\t.equ\t"#name",%0" \
                "\n\t.type\t"#name",@object" \
...
#endif	/* _VX_CPU_FAMILY == _VX_ARM || _VX_CPU_FAMILY == _VX_SH && _VX_CPU_FAMILY != _VX_PENTIUM */
