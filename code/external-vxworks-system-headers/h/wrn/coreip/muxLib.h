...
/*
 * Copyright (c) 2001-2008, 2010 Wind River Systems, Inc.
 *
...
--------------------
03w,10nov10,dlk  Move extern "C" after last header file include. WIND00240828.
03v,28mar08,dlk  Added muxProtoInfoGet()/muxProtoListGet().
                 Pass the PROTO_COOKIE also to mux2Bind() protocol shutdown
                 routines.
03u,26feb08,dlk  MUX2 redesign.
03t,12oct07,dlk  Made muxEndRxJobQueue() public. Added muxEndQnumGet().
                 Added muxErrorPost(). muxIfFuncBase scalability.
03s,20sep07,dlk  Added muxLinkUpNotify() and muxLinkDownNotify().
03r,02jan07,kch  Added muxIterate() prototype.
03q,05aug06,kch  Cleanup.
