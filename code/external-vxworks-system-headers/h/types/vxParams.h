...
--------------------
01i,10oct13,ghs  Expand _PARM_PATH_MAX to be compatible with Windows FAT32
                 (WIND00438274)
01h,14sep12,yjl  Fix WIND00376255, dosFs to be compatible with Windows FAT32
                 naming rules for file/directory name length
01g,24oct05,md   changed _PARM_PATH_MAX count to include null terminator
01f,19feb04,dat  Chg name and path lengths, requested by jkf
