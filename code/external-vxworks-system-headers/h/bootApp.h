...
--------------------
01j,06jan12,pgh  Remove USB definitions which are local to one file.
01i,04jan12,d_c  Fix warning in bootUsbFsLoad.c
01h,02mar10,pgh  Add ELF class to bootGoPrototype
01g,11dec09,pgh  Remove LOCAL_MEM_LOCAL_ADRS from bootAppInit().
01f,27feb08,jmt  Add support for BSP defined go routines
01e,06feb07,jmt  Add bootAppPrintf to optimize size
01d,29jan07,jmt  Add prototype for bootDevFormatHelpAdd
01c,14nov06,jmt  Defect 81462: Need to disable MMU before booting new image
                 for some BSPs
01b,27jul05,jmt  Fix PPC compile error
...
STATUS bootAppInit(BOOL delayedInit, BOOL disableMmuBeforeEntry); 
void bootApp();
