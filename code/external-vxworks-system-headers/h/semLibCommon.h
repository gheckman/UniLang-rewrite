...
--------------------
01z,07nov13,cww  Merge in support for semi-scalable inline RW semaphores.
01y,12nov10,zl   added SEM_ID_NULL definition
01x,18aug10,s_s  removing shared memory references from enum SEM_TYPE and 
                 changing SEM_TYPE_MAX from 16 to 8
01w,16jun10,pcs  change the data type of timeout from an int to _Vx_ticks_t
01w,05may10,pch  reduced semaphore table size when using small footprint
01v,28apr10,pad  Moved extern C statement after include statements.
01u,15dec09,jpb  Added shared SEM_INFO structure for kernel & user.
01t,09mar09,pcs  Updated to add support for the LP64 data model.
01s,05sep08,cww  Removed semBMinimalXXX() and semMMinimalXXX() APIs 
		 (WIND00133039)
01r,05jul08,gls  added inline give/take routines
01q,07jan08,gls  fast semaphores renamed to minimal semaphores
01p,13dec07,gls  added SEM_TYPE_FAST_MUTEX and SEM_TYPE_FAST_BINARY
01o,14sep07,gls  fixed SEM_TYPE_RW (Defect #WIND00104600)
01n,27jun07,gls  added semExchange()
01m,21jun07,mfj  Fixing comment reg. read/write semaphores
01l,23jan07,gls  updated reader/writer semaphore support for release
