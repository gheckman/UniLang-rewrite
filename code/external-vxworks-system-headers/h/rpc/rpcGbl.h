...
/* Copyright 1984-1992, 1993-2010, 2012 Wind River Systems, Inc. */
/*
modification history
--------------------
01s,16nov12,xwu  fixed WIND00388613  the coverity issue of RPC
01r,29apr10,pad  Moved extern C statement after include statements.
01q,25jan10,y_t    update for LP64
01p,16nov01,spm  fixed modification history: version 01o created
01o,25oct01,rae  added build macro to support different Tornado versions
01n,16nov98,mak  changes due to moving pRPCModList from the TCB to the LCB
...
#define taskRpcStatics	(windLcbCurrent->pRPCModList)
#else
