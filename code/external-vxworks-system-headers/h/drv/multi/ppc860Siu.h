...
/*
 * Copyright (c) 1996, 1998, 2001, 2005, 2007, 2010 Wind River Systems, Inc.
 *
...
--------------------
01k,10mar10,wqi  Reversed SIUMCR_PNCS and SIUMCR_OPAR. (WIND00061321)
01j,05sep07,dtr  Fix IRQ defs.
01i,29may05,mig  Added support for MPC866 PLPRCR register. SPR# 109471
...
#define SIUMCR_PNCS		0x00004000	/* Parity Non-mem Crtl reg */
#define SIUMCR_OPAR		0x00008000	/* Odd Parity */
...
#define TBSCR_TBIRQ7	0x0100	/* Time Base Interrupt Request 7 */
#define TBSCR_TBIRQ6	0x0200	/* Time Base Interrupt Request 6 */
#define TBSCR_TBIRQ5	0x0400	/* Time Base Interrupt Request 5 */
#define TBSCR_TBIRQ4	0x0800	/* Time Base Interrupt Request 4 */
#define TBSCR_TBIRQ3	0x1000	/* Time Base Interrupt Request 3 */
#define TBSCR_TBIRQ2	0x2000	/* Time Base Interrupt Request 2 */
#define TBSCR_TBIRQ1	0x4000	/* Time Base Interrupt Request 1 */
#define TBSCR_TBIRQ0	0x8000	/* Time Base Interrupt Request 0 */
...
/* Additional PLPRCR bit definitions for the MPC866 */

#define PLPRCR_MFN_MSK		0xf8000000	/* Numerator of the multiplication factor */
#define PLPRCR_MFN_SHIFT	0x0000001b	/* Numerator shift */
#define PLPRCR_MFD_MSK		0x07c00000	/* Denominator minus 1 of the multiplication factor */
#define PLPRCR_MFD_SHIFT	0x00000016	/* Denominator shift */
#define PLPRCR_S_MSK		0x00300000	/* Divider after the Double Clock */
#define PLPRCR_S_SHIFT		0x00000014	/* Divider shift */
#define PLPRCR_MFI_MSK		0x000f0000	/* Interger part of the multiplication factor */
#define PLPRCR_MFI_SHIFT	0x00000010	/* Interger part shift */
#define PLPRCR_PDF_MSK		0x0000001e	/* Predivision factor minus 1 */
#define PLPRCR_PDF_SHIFT	0x00000001	/* Predivision shift */
#define PLPRCR_DBRMO_MSK	0x00000001	/* DPLL BRM Order bit */
#define PLPRCR_DBRMO_SHIFT	0x00000000	/* DPLL BRM shift */
