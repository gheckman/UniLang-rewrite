...
--------------------
01g,06aug07,rec  add FLASH_29WS064J
01g,25jul07,dtr  Support S29GLxxx parts.
...
#ifdef S29GLXX
#define	FLASH29_CMD_FIRST		(FLASH_DEF) 0x00aa00aa
#define	FLASH29_CMD_SECOND		(FLASH_DEF) 0x00550055
#define	FLASH29_CMD_FOURTH		(FLASH_DEF) 0x00aa00aa
#define	FLASH29_CMD_FIFTH		(FLASH_DEF) 0x00550055
#define	FLASH29_CMD_SIXTH		(FLASH_DEF) 0x00100010
#define	FLASH29_CMD_SECTOR		(FLASH_DEF) 0x00300030

#define	FLASH29_CMD_PROGRAM		(FLASH_DEF) 0x00a000a0
#define	FLASH29_CMD_CHIP_ERASE		(FLASH_DEF) 0x00800080
#define	FLASH29_CMD_READ_RESET		(FLASH_DEF) 0x00f000f0
#define	FLASH29_CMD_AUTOSELECT		(FLASH_DEF) 0x00900090
#else
...
#define FLASH_29WS064J                  0x7E    /* device code S29WS064J */
