...
/*
 * Copyright (c) 1994, 2000, 2009 Wind River Systems, Inc.
 *
...
--------------------
01c,07jul09,my_  added volatile to FLASH_CAST(WIND00113914)
...
#define FLASH_CAST      (volatile UINT8 *)
#endif  /* FLASH_WIDTH */

#if     (FLASH_WIDTH == 2)
#define FLASH_DEF       UINT16
#define FLASH_CAST      (volatile UINT16 *)
#endif  /* FLASH_WIDTH */

#if     (FLASH_WIDTH == 4)
#define FLASH_DEF       UINT32
#define FLASH_CAST      (volatile UINT32 *)
#endif  /* FLASH_WIDTH */
