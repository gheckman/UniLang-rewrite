/* ixp425Sio.h - Intel IXP425 UART header file */
...
#ifndef __INCixp425Sioh 
#define __INCixp425Sioh 
 ...
 * #define IXP425_SIO_MAX_CNT 30
 */
#define IXP425_SIO_MAX_CNT 32
#define IXP425_SIO_MAX_RX_CNT 63
#define IXP425_SIO_MAX_TX_CNT 31


typedef  struct 	/* IXP425_SIO_CHAN */
    {
    /* always goes first */
    ...
    UINT8 	*regs;		/* IXP425 UART registers */
...
extern void ixp425SioInt (IXP425_SIO_CHAN *);
extern void ixp425SioDevInit (IXP425_SIO_CHAN *);
extern void ixp425SioStatsShow (IXP425_SIO_CHAN *);

#else

extern void ixp425SioInt ();
extern void ixp425SioInit ();
extern void ixp425SioStatsShow ();
