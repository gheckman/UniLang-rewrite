...
/* Copyright 1997-1998, 2001-2002, 2006, 2008, 2010 Wind River Systems, Inc. */ 
...
01f,08sep06,scm  update local apic id for cluster & cpu id...
01e,26jul06,scm  update for pentium/xeon support...
...
#define LOAPIC_PHY_PRC_ID_MASK	0x06000000 /* PHYSICAL PROCESSOR ID [26-25] mask */
...
/* logical ID to base address */
#define LID_TO_BASE(apic) ((UINT32)mpApicAddrTable[apic])

/* irq to bus irq */
#define IRQ_TO_BIRQ(apic, irq) mpApicIrqToBusIrq(apic, irq)

/* offset within sysInumTbl depends on the logical apic id */
#define IRQ_OFFSET(apic) (mpApicBaseIrq[apic])

/* number of required interrupt entries */
#define NUM_REDIRECTION_ENTRIES(apic) (mpApicRedEntries[apic])
#define NUM_IOAPICS (mpApicNioApic)
