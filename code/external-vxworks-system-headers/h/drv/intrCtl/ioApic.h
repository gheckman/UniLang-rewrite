...
--------------------
01f,26jul06,scm  update for pentium/xeon support...
...
IMPORT UINT32 ioApicVersion[MAX_IOAPICS];  /* IO APIC version register per APIC */
IMPORT UINT8  ioApicRedNum[MAX_IOAPICS];  /* IO APIC redirection table number per APIC */

#if	defined(__STDC__) || defined(__cplusplus)

IMPORT STATUS   ioApicInit       (void);
IMPORT VOID     ioApicEnable     (BOOL enable);
IMPORT STATUS	ioApicIrqSet	 (INT32 irq, INT32 destApicId, INT32 sourceApicId);
IMPORT STATUS   ioApicRedGet     (INT32 irq, INT32 * pUpper32, INT32 * pLower32, INT32 ioApicId);
IMPORT STATUS   ioApicRedSet     (INT32 irq, INT32 upper32, INT32 lower32, INT32 ioApicId);
