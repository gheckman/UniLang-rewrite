...
01i,10jan05,rfr  Added ATA_CMD_WRITE_FLUSH
...
#define ATA_COMMAND(base0)  (base0 + 0x7C) /* (W)  command register        */
#define ATA_STATUS(base0)   (base0 + 0x7C) /* (R)  immediate status        */
#define ATA_A_STATUS(base1) (base1 + 0x5C) /* (R)  alternate status        */
#define ATA_D_CONTROL(base1)    (base1 + 0x5C) /* (W)  disk controller control */
#define ATA_D_ADDRESS(base1)    (base1 + 0)    /* (R)  disk controller address NOT USED*/
