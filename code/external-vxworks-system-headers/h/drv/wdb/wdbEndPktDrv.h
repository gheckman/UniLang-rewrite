...
--------------------
01n,08jan10,dbt  Increased WDB END driver MTU (support for fragmented packets
                 have been added in driver).
01m,07dec05,dbt  Replaced bool_t with BOOL.	
		 Cleanup header files inclusion
01l,10feb04,dbt  Decreased MTU to 512 to avoid packet fragmentation (this is
                 not supported with WDB END driver).
