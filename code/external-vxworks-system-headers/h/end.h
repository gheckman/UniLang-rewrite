...
/*
 * Copyright (c) 1996-2007, 2010 Wind River Systems, Inc.
 *
...
--------------------
03x,02feb10,h_k  changed flags type to int from long.
03w,23jul08,dlk  To avoid problems with redundant Ipcom_pkt typedefs, use
                 'struct Ipcom_pkt_struct *' rather than 'Ipcom_pkt *' args.
03v,11may08,dlk  END2 polled mode support.
03u,08apr08,dlk  END2 drivers use END2_NET_FUNCS extension of NET_FUNCS, and
                 move header parsing to hdrParse callback.
03t,28mar08,dlk  Added unloadInfo member to END_OBJ for asynchronous shutdown
                 support.
03s,22Mar08,dlk  MUX2 redesign. 1st checkin.
03r,20jul07,kch  Added END_ERR_L2VID_NOTIFY and END_ERR_L2PVID_NOTIFY layer 2
