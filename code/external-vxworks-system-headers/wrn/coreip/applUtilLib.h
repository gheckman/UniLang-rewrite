...
--------------------
01n,07aug04,dlk  Substantial changes for scalability and consistency with
                 syslog API.
01m,20aug04,rp   merged from COMP_WN_IPV6_BASE6_ITER5_TO_UNIFIED_PRE_MERGE
01l,03aug04,nee  Removing distinction between LOG_* as functions or macros
...
01j,03feb04,zhr  Added telnet client to logging categories
01j,27jan04,asr  Added rlogin  & remLib to logging categories
01i,06dec03,niq  Fix compile error with GNU
01h,24nov03,asr  added an include for semLib.h
                 moved diab version of LOG_XXXX to applUtilLib.c to get rid of warnings
01g,20nov03,niq  osdep.h cleanup
01f,01nov03,asr  Changes to port application logger to RTP
01e,22aug03,niq  Merging from Accordion label ACCORDION_BASE6_MERGE_BASELINE
01d,15jul02,rvr  defined inline functions for LOG_INFO,LOG_ERROR,LOG_WARNING
                 and LOG_DEBUG for diab compiler
01c,21may02,ppp  adding taskLib.h for T2 build
01b,21Jan02,ism  change logging macros to remove need for array
01a,18Sep01,ism  written
*/
...
#define CAT_SHIFT	8
#define CAT_MASK	((UINT)(-(1 << CAT_SHIFT)))
