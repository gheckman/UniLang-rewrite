...
--------------------
03i,15jul12,ggz  WIND00306857 - Add _ALLOC_ALIGN_SIZE alignment support.
03h,10nov10,dlk  Move extern "C" after last header file include. WIND00240828.
03g,27oct09,dlk  Merge LP64 support.
03f,30jul09,dlk  WIND00168645 - use deterministic spin locks by default.
03e,16jun08,dlk  Remove _pNullPoolFuncTbl; rename nullPoolInit() to
                 vxmux_null_buf_init().
03d,21may08,dlk  Remove include of <private/memPartLib.h>.
03c,22mar08,dlk  Split 16-bit offset1 into 8-bits each offset1 and offset2,
                 to support CSUM_IPHDR_OFFSET(). Preliminary MUX2 redesign.
03b,16jan08,dlk  Rename spinLockFastLib --> spinlockIsrNdLib.
03a,20dec07,dlk  For SMP performance patch only, pad fast spin lock so that
                 size of NET_POOL does not change.
02z,10dec07,dlk  Use fast spin lock for mutual exclusion in SMP case.
02y,31aug07,dlk  Increase stack size for NET_REL_IN_TASK tasks to avoid
                 stack overflow (WIND00102321).
02x,21feb07,dlk  Revert prototype change for netBufLibInit(); add
                 netBufLibInitialize() routine instead, and deprecate
		 netBufLibInit().
02w,09mar07,kch  Merged from base6_iter12_smp-dev - Add spinlocks for SMP
                 support.
02v,12feb07,dlk  Make leading pad space configurable.
02u,26dec06,wap  Add support for leading pad space
02t,12sep06,kch  Replaced (struct ifnet *) with (void *) in M_PKT_HDR.
02s,12jun06,dlk  Add nullBufPool support for IPCOM.
02s,10may06,dlk  Correct dbgClFree() prototype.
02r,06mar06,kch  Removed ALTQ_RED that protects altq_hdr from M_PKT_HDR
                 (SPR#118453).
02q,06feb06,kch  Rename hdr pointer in mBlkPktHdr to altq_hdr.
02p,04feb06,kch  Added hdr pointer to save header position to mBlkPktHdr
                 for ALTQ support.
02o,30jan06,dlk  Replace clTotAlloc with clAllocFail. Use FFS() rather than
		 ffsMsb().
02n,14oct05,niq  Debugging changes
02m,25aug05,dlk  Add section tags.
02l,12aug05,dlk  Added M_HEADER flag, overloading M_PROMISC.
02k,25jul05,dlk  Move some routines from netBufLib to netBufAdvLib for better
                 scalability.  Some previously LOCAL routines given external
		 linkage as a result.
		 Add vlan and qnum members to mBlkPktHdr.
02j,22jul05,vvv  removed duplicate macro definitions (SPR #107343)
02i,01arp05,dlk  Replace 'bestFit' with 'noSmaller'.
02h,07feb05,wap  Allow sysctl init routines to be scaled out
02g,18oct04,dlk  Added CL_ALIGN_MIN definition and pNetMemReq function
                 (SPRs #102569, #102771).
02f,23aug04,rp   merged from COMP_WN_IPV6_BASE6_ITER5_TO_UNIFIED_PRE_MERGE
02e,19jul04,niq  Move sysctl initialization to the component init routine
02d,16jun04,wap  Add support for netBufRelease
02c,24nov03,wap  Merge in changes from Snowflake
02b,05nov03,cdw  Removal of unnecessary _KERNEL guards.
02a,04nov03,rlm  Ran batch header path update for header re-org.
01z,03nov03,rlm  Removed wrn/coreip/ prefix from #includes for header re-org.
01z,20nov03,rhe  UBM Base 6 Itn 3 Merge from WRAMP branch
02a,17nov03,rhe  Updated errno values.
                 ...
                 Updated prototypes.  
01z,23Oct03,rhe  reintroduced linkbuf support. (M_LINK and M_LINKID)
                 Added external reference for _pNetPoolFuncTbl &
                 _pLinkPoolFuncTbl.
01y,24sep03,kkz  Rebase with Base6 ITER2 FRZ7 (from ver 01q,05sep03,rhe)
01x,15sep03,vvv  updated path for new headers
01w,08sep03,vvv  merged from ACCORDION_BASE6_MERGE_BASELINE
01v,10jun03,vvv  include netVersion.h
01u,01may03,spm  Tornado 2.2 CP1 merge (from ver 01p,13jan03,rae:
                 TOR2_2-CP1-F label, tor2_2-patch branch, /wind/river VOB)
01t,08apr03,ann  added the prototypes for the SHOW routines - SPR# 86899
01s,26mar03,vvv  conditionally define *_MIN parameters (SPR #87113)
01r,01feb03,pas  added MT_TAG for FreeBSD 4.7 changes
01q,13jan03,ann  merged Team-F1's ipsec changes
                 - changed the NUM_DAT for the larger clusters to zero
                 - added support for large clusters (4K to 64K)
01p,25jun02,pas  conditionally re-enable MSIZE for old drivers
01o,12jun02,pas  changed minimum cluster size to 16
                 added stats for cluster min/max/avg size request
01n,04jun02,pas  changed NUM_nn to NUM_DAT_nn
01m,14jan00,ham  changed struct poolFunc.pInitRtn's API, poolInit()'s API
                 as well for PD support.
01s,27aug03,rae  add large block sizes
01r,29jul03,wap  add linkbuf support
01q,24jun03,rae  add #include netVersion.h
01q,05sep03,rhe  Base6 Iteration2 Merge from WRAMP sandbox
01q,28aug03,rhe  Base 6, Iteration 2. Added Tuple MACROs and netPool attributes. 
