...
--------------------
01f,14may08,brg  SIFBRDADDR ioctl added for ipvxcompat
01e,17sep07,rme  Added SIOCBEATTY to support socket as TTY
01d,20aug07,kch  Added SIOCGIFCAP support (WIND00102912).
01c,12jul07,kch  Added SIOCSETVLANPRI ioctl mapping.
01b,12dec06,kch  Added SIOCXPROMISC and corrected some inline comments.
...
#define SIOCXGIFADDR_IN6   VX_IOWR(INET6, 6, W, struct in6_aliasreq)
