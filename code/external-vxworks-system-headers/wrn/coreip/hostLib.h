...
--------------------
02n,09jan12,h_x  Move extern "C" after last header file include.
02m,23aug07,tkf  Add scopeStr field to ADDR6 as part of the fix for
                 CQ:WIND00102553
02l,07jun07,tkf  Remove #ifdef INET from around ADDR4 (WIND00095796)
02k,24apr07,tkf  Add IPv6-Only build support.
02j,27feb07,dlk  Remove freehostent() prototype.  Add HOSTENT_ALLOC_* defines.
02i,12feb07,dlk  Add rtpHostLibInit() prototype.
02h,21nov06,tlu  Remove errCode from structure addrinfoArgs
02g,08nov06,tkf  Corrected misplacement of freehostent declaration. Also added
                 wrapperHostLib.h for backwards compatibility.
02f,16oct06,kch  Added addrinfoArgs definition for passing arguments to sysctl.
02e,28sep06,kch  Restore freehostent() prototype.
02d,16sep06,tlu  Remove getservbyport(), getservbyname(), getnameinfo(),
...
02c,24aug06,tkf  Remove gethostbynameInit() and gethostbyaddrInit()
                 prototypes.
02b,19jun06,jpb  Removed I960 check.
