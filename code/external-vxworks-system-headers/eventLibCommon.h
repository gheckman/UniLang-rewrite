...
/*
 * Copyright (c) 2001-2003, 2009-2010 Wind River Systems, Inc.
 *
...
--------------------
01f,16jun10,pcs  Change data type of timeout from an int to _Vx_ticks_t
01e,28apr10,pad  Moved extern C statement after include statements.
01d,12mar09,pcs  Updated to add support for the LP64 data model.
