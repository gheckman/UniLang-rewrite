...
/* Copyright 1984-2005, 2010, 2012 Wind River Systems, Inc. */
/*
modification history
--------------------
01y,01nov12,whu  added back SM_MASTER to backward compatibility.
01x,17oct12,whu  fixed defect WIND00381666. Replaced SM_MASTER with smMaster.
01w,29apr10,pad  Moved extern C statement after include statements.
01v,17mar05,bwa  added smIsInstAlive().
01u,31aug04,bwa  moved DEFAULT_CPUS_MAX from smPktLib.h (SPR97418).
01t,05mar02,mas  added SM_MAX_WAIT (SPR 73371)
01s,14nov01,mas  added smLibInit() prototype for future common code base
01r,16mar99,dat  added SM_INT_USER_1/2 (SPR 25804)
...
#define SM_MAX_WAIT		3000	/* max ticks to wait for master boot */
...
#define SM_INT_USER_1		8	/* User defined proc #1 */
					/* (smUtilUser1Rtn)(arg1,arg2,arg3)*/
#define SM_INT_USER_2		9	/* User defined proc #2 */
					/* (smUtilUser2Rtn)(arg1,arg2,arg3)*/
...
extern void	smLibInit (void * pRgnCfgTbl, UINT objSize, UINT netSize, UINT smMasterCpu);
