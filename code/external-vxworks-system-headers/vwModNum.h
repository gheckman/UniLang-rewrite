...
--------------------
06e,19oct12,jxu  Added M_ftlLib
06d,25jul11,jlv  Added M_pwrPolicyLib
06c,11jun10,pcs  added M_devMemLib
06b,11dec09,zly  added M_tffsLib 
06a,03feb09,cww  Added M_vxCpuLib
05z,29jun07,gls  added M_spinLockLib
05y,23jun07,bwa  added M_dshm.
05x,17oct06,rlp  Added M_vxdbgLib.
05w,13jul05,dlk  Added IPCOM module number (M_ipcom).
05v,12aug05,pcm  M_hrfsLib, M_erfLib and M_taskPxLib are now unique
05u,08jul05,jln  updated comment
05t,28jun05,jln  add M_taskPxLib
05s,03aug05,dbt  Added core dump errnos.
05r,22jul05,jmt  Add M_erfLib
05q,03feb05,pcm  added M_hrfsLib
05p,22oct04,pch  SPR 92598: add M_excLib
05o,07sep04,jyo  Fixing SPR 100119: Removing references to RT11.
05n,24jun04,jn   Add loadFileLib
05m,16may04,kk   added S_tlsLib mod num
05l,30mar04,dms  Added SHL-specific errno class.
05m,29mar04,jn   Rename rtpLoadLib -> loadRtpLib
05l,16mar04,bpn  Updated errnoTbl.tcl location.
05k,11dec03,gls  added M_sdLib
05j,04dec03,als  removed M_snsLib (merged with M_salLib)
05i,02dec03,bwa  removed M_msgCLib and M_msgSLib
05h,24nov03,ann  added the module numbers for NFSv3
05g,26nov03,bwa  merged M_unLib and M_unCompLib definitions
05f,21nov03,bwa  added M_unLib and M_unCompLib definitions;
		 added M_salLib and M_snsLib
05e,14oct03,gls  added M_pgMgrLib
05d,18nov03,yvp  Added M_hookLib.
05c,28oct03,jn   Add M_rtpLoadLib
05b,18sep03,vvv  added M_ipRouteLib
05a,11aug03,yp   adding M_adrSpaceLib and M_pgPoolLib
04z,26aug03,dbs  added ED&R modules M_edrLib, M_pmLib, M_memLogLib
04y,26aug03,yvp  Added M_syscallLib
04x,11apr03,pes  PAL Coprocessor Abstraction: Added M_coprocLib
04w,01jul03,nrj  added RTP support
04v,15jul03,kam  rebased to Base6 integration branch
04u,20jun03,t_m  added module number for Card and Socket services (pccard)
04t,04jun03,bwa  Added M_msgCLib and M_msgSLib definitions.
04s,04jun03,kam  added M_isrLib
04r,18feb03.bpn  Added M_shellLib and M_shellCmdLib.
...
#define M_tffsLib		(203 << 16)
#define M_devMemLib		(204 << 16)
#define M_pwrPolicyLib          (205 << 16)

#define M_ftlLib                (206 << 16)
