...
/*
 * Copyright (c) 1984-2004, 2010, 2013 Wind River Systems, Inc.
 *
...
--------------------
01t,28mar13,jxu  eTFFS: added getFreeSectors and validateSector
...
struct tTL 
    ...
    SectorNo (*getFreeSectors) (TLrec *, int * pDefragNeeded, int * pWlNeeded);
#endif
