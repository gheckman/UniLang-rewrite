...
#if defined(__VERSION_NUMBER__) && (__VERSION_NUMBER__ >= 10000)
#   define __STL_HAS_NAMESPACES
#endif
#   define ptr_gen(x)   x
#   define __DCC_USE_PLAIN_VECTOR
#   define __DCC__DEFAULT_ARG_BUG
#   define __ALLOC_NEEDS_STATIC
#   define __ALLOC_NEEDS_CORRECT_ARGS
#   define __DCC__USING_ACCESS_BUG
# endif
...
#   else
#     define __STL_DEFAULT_ALLOCATOR(T) stl_alloc
#   endif
# endif
