...
typedef malloc_alloc stl_alloc;
...
typedef __default_alloc_template<__NODE_ALLOCATOR_THREADS, 0> stl_alloc;
...
# ifdef __STL_WIN32THREADS
  ...
  // does anything.
  static stl_alloc __node_allocator_dummy_instance;
# endif
...
template <class _Tp>
class allocator {
  typedef stl_alloc _Alloc;          // The underlying allocator.
public:
...
struct _Alloc_traits<_Tp, allocator<_Tp1> >
{
  ...
  typedef simple_alloc<_Tp, stl_alloc> _Alloc_type;
