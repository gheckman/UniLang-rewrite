...
#define _Mtxinit(mtx)		((void)(*(mtx) = __diab_alloc_semaphore()))
#define _Mtxdst(mtx)		(__diab_free_semaphore(*(mtx)))
#define _Mtxlock(mtx)		(__diab_lock_semaphore(*(mtx)))
#define _Mtxunlock(mtx)		(__diab_unlock_semaphore(*(mtx)))
