...
#ifdef __ETOA_NAMESPACES
#ifndef __EDG_RUNTIME_USES_NAMESPACES
...
#if __EDG_IA64_ABI_VARIANT_CTORS_AND_DTORS_RETURN_THIS
    typedef void* __ctor_dtor_return_type;
#else /* if ! __EDG_IA64_ABI_VARIANT_CTORS_AND_DTORS_RETURN_THIS */
    typedef void __ctor_dtor_return_type;
#endif /* if __EDG_IA64_ABI_VARIANT_CTORS_AND_DTORS_RETURN_THIS */

    /* Guard variables are 64 bits in the IA-64 ABI but only 32 bits in
       the ARM EABI. */
#if __EDG_IA64_ABI_USE_INT_STATIC_INIT_GUARD
    typedef int __guard_variable_type;
#else /* if ! __EDG_IA64_ABI_USE_INT_STATIC_INIT_GUARD */
    typedef unsigned long long __guard_variable_type;
#endif /* if __EDG_IA64_ABI_USE_INT_STATIC_INIT_GUARD */
