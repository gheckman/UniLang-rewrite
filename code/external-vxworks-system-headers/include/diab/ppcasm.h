...
extern void __eieio( void) __attribute__((intrinsic_function(8, 4, "eieio") ));
...
extern char __lbdx( const void*,  int) __attribute__((intrinsic_function(2003, 0, "lbdx") ));
extern char __lbepx( const void*,  int) __attribute__((intrinsic_function(2003, 0, "lbepx") ));
extern unsigned short __lhdx( const void*,  int) __attribute__((intrinsic_function(2003, 0, "lhdx") ));
extern unsigned short __lhepx( const void*,  int) __attribute__((intrinsic_function(2003, 0, "lhepx") ));
extern int __lwdx( const void*,  int) __attribute__((intrinsic_function(2003, 0, "lwdx") ));
extern int __lwepx( const void*,  int) __attribute__((intrinsic_function(2003, 0, "lwepx") ));
extern void __lwsync( void) __attribute__((intrinsic_function(8, 4, "lwsync") ));
extern void __mbar( const unsigned int) __attribute__((intrinsic_function(7, 4, "mbar") ));
extern int __mfcr( void) __attribute__((intrinsic_function(2083, 1, "mfcr") ));
...
extern int __mfsprg( const unsigned int) __attribute__((intrinsic_function(2016, 0, "mfsprg") ));
...
extern void __mtsprg( const unsigned int,  int) __attribute__((intrinsic_function(2090, 0, "mtsprg") ));
extern void __nop( void) __attribute__((intrinsic_function(8, 4, "nop") ));
extern void __sync( const unsigned int) __attribute__((intrinsic_function(7, 4, "sync") ));
