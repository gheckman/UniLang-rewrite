...
#pragma nodebug_function __mem_ptr, __reg_ptr
...
#pragma nodebug_function __va_gpr, __va_fpr, __va_vr, __va_mem, __va_reg
...
#define va_start(list,parmN) (list = (va_list)(((unsigned long)&parmN + sizeof(parmN) + 7) & ~7))
#define va_end(list)  ((void)0)
...
#pragma nodebug_function __va_mem
...
#pragma nodebug_function __va_next_o, __va_next_o_limit, __va_next_fp, __va_next_fp_limit, __va_next_stack
