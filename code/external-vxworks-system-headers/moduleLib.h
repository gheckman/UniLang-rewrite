...
/*
 * Copyright (c) 1992, 1996, 2003-2005, 2009-2010,2013 Wind River Systems, Inc. 
 *
...
--------------------
01u,11jun13,elp  Prevent checking a module while loading (CQ:WIND00408631).
01t,17dec10,jmp  Updated moduleEach() and moduleSegEach() to use fully
                 qualified function pointer instead of FUNCPTR
                 (CQ:WIND00246939).
01s,01apr10,pad  Moved declaration of extern C block for C++ after the
                 inclusion of header files.
01r,22feb10,v_r  LP64 TODOS cleanup.
01q,18jan10,rlp  Added undefined and common symbol lists.
01p,16jun09,v_r  LP64 adaptation: updated segment sizes to size_t.
01o,30apr09,v_r  LP64 adaptation (phase #1) : updated code following code
                 adaptation guidelines (excepted FUNCPTR mods and struct reorg).
01n,14feb05,v_r  Fixed SPR #98274 (loader errno review).
	         Moved private routines to moduleLibP.h
	         Added segment type for loadFileLibP.h
		 Cleanups.
01m,02feb05,v_r  Fixed SPR #104657 (moduleShow() does not present display
...
01l,10jan05,v_r  Fixed SPR #104659 (moduleShow now a separate component, need
                 to include moduleShow.h in moduleLib.h)
01k,21oct04,x_p  Added moduleSectionDescFree() prototype.
01j,18sep04,jn   Move towards shared code for host and target
01i,05apr04,jn   Clean up - remove unused declarations and development-related
                 comments
01h,03apr03,jn   merge from AE loader moduleLibh 
01g,03apr03,to   replaced OBJ_CORE with HANDLE in MODULE (de-classify).
