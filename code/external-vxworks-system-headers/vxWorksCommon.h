...
/*
 * Copyright (c) 1990-1992, 1994, 1996-1997, 1999, 2001, 2003-2010
...
--------------------
04m,17jun10,pcs  Change the macro WAIT_FOREVER from -1 to -1U
04l,19jan10,pad  Added logic allowing to keep using FUNCPTR/VOIDFUNCPTR in API
                 on VxWorks 32-bit.
04k,23jan09,pcs  Updated to add support for LP64 data model.
04k,29oct08,cww  Remove max/min macros completely for C++
04j,22aug08,cww  Changed conditions under which max and min are defined
		 (WIND00086197)
04i,10may07,zl   added ARCH_HEADER macro.
04h,09may07,mmi  move VX_MAX_SMP_CPUS outside #ifndef/#endif _WRS_KERNEL
04g,27apr07,tkf  Removed network configuration parameters.
04g,17apr07,kk   move VX_MAX_SMP_CPUS to here
04f,23may06,jpb  Updated for POSIX namespace conformance.  
		 Changed C preprocessor macro TOOL_FAMILY to _VX_TOOL_FAMILY.
04e,20jan06,mil  Updated for POSIX namespace conformance.
04d,22jun05,mcm  Added _WRS_BIT_OR macro definition.
