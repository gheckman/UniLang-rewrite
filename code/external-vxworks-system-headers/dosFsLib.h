...
/*
 * Copyright (c) 1999-2006, 2009-2010, 2012 Wind River Systems, Inc.
 *
...
-------------------- 
02r,26jun12,zly  Fix WIND00342075: Add new API dosFsVolFormatWithLabel(). 
02q,29jul10,jxu  Add C++ inline wrappers for dosFsVolFormat() and 
                 dosFsVolFormatFd() API.
02p,07jun10,jxu  Removed usage of FUNCPTR.
02o,27may10,pad  Moved extern C statement after include statements.
02n,08apr10,sjz  Fix WIND00090292: add const to the prototype of dosFsVolFormat
02m,17mar10,yjl  use different funtion pointer between 32bit and 64bit
02l,04nov09,yjl  change name of dosFsFmtRtn to _func_dosFsFmtRtn
02k,04aug09,yjl  adapt for 64bit
02l,03aug09,hps  requirement WIND00142043, group cache with background flush
02k,22jul09,yjl  requirement WIND00142043
02j,26sep08,zly  changed maxRootEnts from M(modifiable) to C(calculated)
02i,03nov06,pcm  added routines to tune DosFS Cache
02h,22aug06,pcm  added dosFsShowInit()
02g,17aug06,kuo  added macro DOS_WRITE_THROUGH_MASK
02f,10apr06,pcm  changed dosFsDevCreate() <dosDevCreateOptions> parameter type
02e,04oct05,dcc  added miselaneous cache routines.
02d,05aug05,dcc  added dosFsCacheLibInit() declaration.
02c,04aug05,jlk  moved formatter function pointer, dosFsFmtRtn, from dosFsLibP.h
02b,03aug05,pcm  changed parameters to dosFsLibInit()
02a,20jun05,dcc  updated formatter API.
01z,25may05,dcc  added cache support.
01y,18may05,dcc  added API to plug into the removability framework.
01x,18apr05,dcc  updated dosFs formatter to work over rawFs.
01w,31jan05,dcc  updated dosFs to use XBD interface.
01v,23sep04,act  back out changes for SPR#90008
01u,03may04,jkf  SPR#90008, adding device deletion routine
01t,27apr04,act  add DOS_FILENAMES_UNICODE option
01s,09apr04,dat  creating dosFsCommon.h
01r,21mar04,act  add DOS_CHK_FORCE and DOS_CHK_FLAGS_MASK for clean bit
01q,02sep03,jkf  rename autoChkLevel to dosDevCreateOptions, more generic.
                 added DOS_WRITE_THROUGH_[USR,ALL,FAT,DIR] options.
