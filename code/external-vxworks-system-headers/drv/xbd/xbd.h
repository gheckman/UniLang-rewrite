...
/*
 * Copyright (c) 2004-2007, 2009-2010, 2012-2014 Wind River Systems, Inc.
 *
...
--------------------
02b,17sep14,txu  add S.M.A.R.T support (VXW6-82629)
02a,21jan14,m_y  remove xbd block cache parameter
01z,31dec13,m_y  modify to component the xbd block cache module
01y,06dec13,m_y  re-design the xbd blk cache
01x,19nov13,m_y  add flag to sync the request (WIND00441663)
01w,22oct13,m_y  add function declaration to remove compile warning 
01v,16oct13,m_y  disable the debug information 
01u,15aug13,m_y  add code to support gpt 
01t,30nov12,w_x  add code to support xbd sched policy 
01s,04jun10,jxu  LP64: added void to xbdInit prototype as parameter.
01r,29apr10,pad  Moved extern C statement after include statements.
01q,10jul09,lyc  LP64 support
01p,03jul09,hps  check-in for WIND00142042
01o,03may07,pcm  added XBD_GETINFO ioctl (WIND00091025)
01n,12apr06,dee  SPR 119990, WIND00037359 - add cplusplus construct
