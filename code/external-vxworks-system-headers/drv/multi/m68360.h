...
/* Copyright 1994-1996, 2010 Wind River Systems, Inc. */

/*
modification history
--------------------
01f,29jul10,pad  Moved extern C statement after include statements.
01e,05dec96,db	 fixed macro M360_DPR_TMR per SPR #7575.
01d,28may96,dat  fixed SPR #5616, new macros for SMC in GCI mode
...
#define M360_DPR_TMR(base)	((UINT32 *) (base + 0xdb0))
...
/* GCI MODE Buffer Descriptors */

#define	M360_SMC1_M_RXBD(base)	((UINT16 *) (base + 0x0E80))
#define	M360_SMC1_M_TXBD(base)	((UINT16 *) (base + 0x0E82))
#define	M360_SMC1_CI_RXBD(base) ((UINT16 *) (base + 0x0E84))
#define	M360_SMC1_CI_TXBD(base) ((UINT16 *) (base + 0x0E86))

#define	M360_SMC2_M_RXBD(base)	((UINT16 *) (base + 0x0F80))
#define	M360_SMC2_M_TXBD(base)	((UINT16 *) (base + 0x0F82))
#define	M360_SMC2_CI_RXBD(base) ((UINT16 *) (base + 0x0F84))
#define	M360_SMC2_CI_TXBD(base) ((UINT16 *) (base + 0x0F86))
...
#define M360_CPM_SIRAM(base)	((UINT16 *) (base + M360_REGB_OFFSET + 0x700))

/* SMC GCI Monitor Channel Receive Buffer Descriptor */

#define	SMC_GCI_MON_RXBD_E	0x8000
#define	SMC_GCI_MON_RXBD_L	0x4000
#define	SMC_GCI_MON_RXBD_ER	0x2000
#define	SMC_GCI_MON_RXBD_MS	0x1000
#define	SMC_GCI_MON_RXBD_AB	0x0200
#define	SMC_GCI_MON_RXBD_EB	0x0100

/* SMC GCI  Monitor Channel Transmit Buffer Descriptor */

#define	SMC_GCI_MON_TXBD_R	0x8000
#define	SMC_GCI_MON_TXBD_L	0x4000
#define	SMC_GCI_MON_TXBD_AR	0x2000
#define	SMC_GCI_MON_TXBD_MS	0x1000
#define	SMC_GCI_MON_TXBD_AB	0x0200
#define	SMC_GCI_MON_TXBD_EB	0x0100

/* SMC GCI C/I Channel Receive Buffer Descriptor */

#define	SMC_GCI_CI_RXBD_E	0x8000
#define SMC_GCI_CI_DATA_MASK	0x003F

/* SMC GCI  C/I Channel Transmit Buffer Descriptor */

#define	SMC_GCI_CI_TXBD_R	0x8000

/* SMC GCI Event and Mask Register definitions */

#define	SMC_GCI_SMCX_CTXB	0x08
#define	SMC_GCI_SMCX_CRXB	0x04
#define	SMC_GCI_SMCX_MTXB	0x02
#define	SMC_GCI_SMCX_MRXB	0x01

/* SMC MODE Register fields in GCI MODE */

#define	SMC_SMCMR_CLEN_1	0x0000
#define	SMC_SMCMR_CLEN_2	0x0800
#define	SMC_SMCMR_CLEN_3	0x1000
#define	SMC_SMCMR_CLEN_4	0x1800
#define	SMC_SMCMR_CLEN_5	0x2000
#define	SMC_SMCMR_CLEN_6	0x2800
#define	SMC_SMCMR_CLEN_7	0x3000
#define	SMC_SMCMR_CLEN_8	0x3800
#define	SMC_SMCMR_CLEN_9	0x4000
#define	SMC_SMCMR_CLEN_10	0x4800
#define	SMC_SMCMR_CLEN_11	0x5000
#define	SMC_SMCMR_CLEN_12	0x5800
#define	SMC_SMCMR_CLEN_13	0x6000
#define	SMC_SMCMR_CLEN_14	0x6800
#define	SMC_SMCMR_CLEN_15	0x7000
#define	SMC_SMCMR_CLEN_16	0x7800

#define SMC_SMCMR_ME		0x0400
#define SMC_SMCMR_MP		0x0200
#define SMC_SMCMR_CN		0x0100
#define SMC_SMCMR_CHAN1		0x0000
#define SMC_SMCMR_CHAN2		0x0100

#define	SMC_SMCMR_SM_GCI	0x0000
#define	SMC_SMCMR_SM_UART	0x0020
#define	SMC_SMCMR_SM_TRANSPARENT 0x0030

#define	SMC_SMCMR_DM_NORMAL	0x0000
#define	SMC_SMCMR_DM_LCLOOP	0x0004
#define	SMC_SMCMR_DM_ECHO	0x0008

#define	SMC_SMCMR_TEN		0x0002
#define	SMC_SMCMR_REN		0x0001
#define SMC_SMCMR_CRX_ENABLE	0x0004


/* SI GLOBAL MODE register */

#define	SI_SIGMR_ENB		0x08
#define	SI_SIGMR_ENA		0x04
#define	SI_SIGMR_RDM_1CHN_64E	0x00
#define SI_SIGMR_RDM_1CHN_32E	0x01
#define SI_SIGMR_RDM_2CHN_32E	0x02
#define SI_SIGMR_RDM_2CHN_16E	0x03

/* SIRAM fields */

#define	SI_SWTR			0x4000
#define	SI_SSEL4		0x2000
#define	SI_SSEL3		0x1000
#define	SI_SSEL2		0x0800
#define	SI_SSEL1		0x0400
#define	SI_CSEL_NS1		0x0000
#define	SI_CSEL_SCC1		0x0040
#define	SI_CSEL_SCC2		0x0080
#define	SI_CSEL_SCC3		0x00C0
#define	SI_CSEL_SCC4		0x0100
#define	SI_CSEL_SMC1		0x0140
#define	SI_CSEL_SMC2		0x0180
#define	SI_CSEL_NS2		0x01C0
#define	SI_CNT_1		0x0000
#define	SI_CNT_2		0x0004
#define	SI_CNT_3		0x0008
#define	SI_CNT_4		0x000C
#define	SI_CNT_5		0x0010
#define	SI_CNT_6		0x0014
#define	SI_CNT_7		0x0018
#define	SI_CNT_8		0x001C
#define	SI_CNT_9		0x0020
#define	SI_CNT_10		0x0024
#define	SI_CNT_11		0x0028
#define	SI_CNT_12		0x002C
#define	SI_CNT_13		0x0030
#define	SI_CNT_14		0x0034
#define	SI_CNT_15		0x0038
#define	SI_CNT_16		0x003C
#define SI_BYT			0x0002
#define	SI_LST			0x0001
