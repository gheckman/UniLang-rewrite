...
/*
 * Copyright (c) 1990-2006 Wind River Systems, Inc.
 *
...
--------------------
01k,25jan06,wap  Add handlerQueued flag
01j,11nov05,wap  Merge in coldfire FEC support
01i,13oct05,mmi  update cache routine references
01h,05dec03,rcs  fixed warnings for base6
...
if (sysFecEnetEnable != NULL)                                           \
    if (sysFecEnetEnable (pDrvCtrl, motFecDmaInt) == ERROR)             \
        return (ERROR);

#define SYS_FEC_ENET_DISABLE                                            \
if (sysFecEnetDisable != NULL)                                          \
    if (sysFecEnetDisable (pDrvCtrl, motFecDmaInt) == ERROR)            \
        return (ERROR);
...
#define MOT_FEC0_CSR_OFF        0x9000  /* CSRs offset in the MCF5475 RAM */
#define MOT_FEC1_CSR_OFF        0x9800  /* CSRs offset in the MCF5475 RAM */
#define MOT_FEC_CSR_OFF		MOT_FEC0_CSR_OFF

#define MOT_FEC_EVENT_OFF       0x9004  /* interrupt event register */
#define MOT_FEC_MASK_OFF        0x9008  /* interrupt mask register */
#define MOT_FEC_CTRL_OFF        0x9024  /* FEC control register */
#define MOT_FEC_MII_DATA_OFF    0x9040  /* MII data register */
#define MOT_FEC_MII_SPEED_OFF   0x9044  /* MII speed register */
#define MOT_FEC_MIB_CSR_OFF     0x9064  /* MII speed register */
#define MOT_FEC_RX_CTRL_OFF     0x9084  /* rx control register */
#define MOT_FEC_RX_HASH_OFF     0x9088  /* rx hash register */
#define MOT_FEC_TX_CTRL_OFF     0x90c4  /* tx control register */
#define MOT_FEC_ADDR_L_OFF      0x90e4  /* lower 32-bits of MAC address */
#define MOT_FEC_ADDR_H_OFF      0x90e8  /* upper 16-bits of MAC address */
#define MOT_FEC_OPC_OFF         0x90eC  /* Opcode pause duration reg address */
#define MOT_FEC_IAHASH_H_OFF    0x9118  /* upper 32-bits of IA hash table */
#define MOT_FEC_IAHASH_L_OFF    0x911c  /* lower 32-bits of IA hash table */
#define MOT_FEC_HASH_H_OFF      0x9120  /* upper 32-bits of group address */
#define MOT_FEC_HASH_L_OFF      0x9124  /* lower 32-bits of group address */
#define MOT_FEC_TFWR_OFF        0x9144  /* FEC Transmit FIFO Watermark */
#define MOT_FEC_RFDR_OFF        0x9184  /* FEC RX FIFO Data Register*/
#define MOT_FEC_RFSR_OFF        0x9188  /* FEC RX FIFO Status Register*/
#define MOT_FEC_RFCR_OFF        0x918C  /* FEC RX FIFO Control Register*/
#define MOT_FEC_RLRFP_OFF       0x9190  /* FEC RX FIFO Last Read Frame Ptr */
#define MOT_FEC_RLWFP_OFF       0x9194  /* FEC RX FIFO Last Write Frame Ptr*/
#define MOT_FEC_RFAR_OFF        0x9198  /* FEC RX FIFO Alarm Register*/
#define MOT_FEC_RFRP_OFF        0x919C  /* FEC RX FIFO Read Pointer Register*/
#define MOT_FEC_RFWP_OFF        0x91A0  /* FEC RX FIFO Write Pointer Register*/
#define MOT_FEC_TFDR_OFF        0x91A4  /* FEC TX FIFO Data Register*/
#define MOT_FEC_TFSR_OFF        0x91A8  /* FEC TX FIFO Status Register*/
#define MOT_FEC_TFCR_OFF        0x91AC  /* FEC TX FIFO Control Register*/
#define MOT_FEC_TLRFP_OFF       0x91B0  /* FEC TX FIFO Last Read Frame Ptr */
#define MOT_FEC_TLWFP_OFF       0x91B4  /* FEC TX FIFO Last Write Frame Ptr */
#define MOT_FEC_TFAR_OFF        0x91B8  /* FEC TX FIFO Alarm Register*/
#define MOT_FEC_TFRP_OFF        0x91BC  /* FEC TX FIFO Read Pointer Register*/
#define MOT_FEC_TFWP_OFF        0x91C0  /* FEC TX FIFO Write Pointer Register*/
#define MOT_FEC_FRST_OFF        0x91C4  /* FEC FIFO Reset Register*/
#define MOT_FEC_CTCWR_OFF       0x91C8  /* FEC CRC and Transmit Frame Control Register*/
#define MOT_FEC_RX_ACT_OFF      0x918c  /* rx FIFO control register*/
#define MOT_FEC_TX_ACT_OFF      0x91ac  /* tx FIFO control register*/
...
#define MOT_FEC_TFAR(x)       (((x)&0x000003FF)<<0)
...
#define MOT_FEC_RFAR(x)       (((x)&0x000003FF)<<0)
...
#define MOT_FEC_MII_SPEED   (((sysCpuSpeed()+9999999)/10000000)<<1)
...
#define MOT_FEC_TBD_INTERRUPT   0x1000          /* interrupt on transmit MCF547x/8x only */
...
LOCAL	FUNCPTR motFecBufInvRtn = cacheInvalidate;
LOCAL	FUNCPTR motFecBufFlushRtn = cacheFlush;
FUNCPTR motFecIntDisc = NULL;   /* assign a proper disc routine */
#endif

#if (CPU_FAMILY == COLDFIRE)
IMPORT STATUS	sysFecEnetAddrGet (UINT32 unit, UCHAR * address);
IMPORT STATUS	sysFecEnetEnable (DRV_CTRL *pDrvCtrl, VOIDFUNCPTR isr);
IMPORT STATUS	sysFecEnetDisable (DRV_CTRL *pDrvCtrl, VOIDFUNCPTR isr);
IMPORT void	sysFecEnetTxResume (DRV_CTRL *pDrvCtrl);
IMPORT void	sysFecEnetRxResume (DRV_CTRL *pDrvCtrl);
