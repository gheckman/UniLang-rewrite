...
--------------------
01i,05feb10,c_t  m5200FecEnd auto neg may fail with high sysClkRate
01h,04jan10,c_t  correct individual & group register offset
...
#define FEC_END_iaddr1_OFF      0x0118	/* Individual Address 1*/
#define FEC_END_iaddr2_OFF      0x011C	/* Individual Address 2*/
...
#define FEC_END_HASH_H_OFF      0x0120  /* upper 32-bits of group address */
#define FEC_END_HASH_L_OFF      0x0124  /* lower 32-bits of group address */
...
#define FEC_END_PHY_MAX_SEC 0x04        /* max delay in seconds */
