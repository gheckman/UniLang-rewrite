...
/*
 * Copyright (c) 1998-2002, 2004, 2010, 2013 Wind River Systems, Inc.
 *
...
--------------------
01k,21mar13,fao  Increase LN_BUFSIZ for maximum ethernet payload.(WIND00408872)
01j,29apr10,pad  Moved extern C statement after include statements.
01i,26sep05,wap  Add TX underflow error indication flag (SPR #111881)
01h,02nov04,wap  Fixed SPR# 102962  and SPR# 103409
01g,08aug04,sru  Added fields to support fast phys-to-virt translation.
...
/* CSR 80 RX and TX FIFO threshold register */

#define CSR80_TXTHR0        0x0400	/* TX threshold low bit */
#define CSR80_TXTHR1        0x0800	/* TX threshold hi bit */
#define CSR80_DEFAULT       0x1410	/* chip default value */
...
#define BCR18_NOUFLO		0x0800	/* TX store and forward mode */
...
#define LS_TX_UFLO		0x800	/* TX underflow occured */
