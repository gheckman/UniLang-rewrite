...
/*
 * Copyright (c) 1997-2001, 2003-2005, 2007 Wind River Systems, Inc.
 *
...
--------------------
01s,19jul07,d_l  change N_MCAST from 12 to 24.(WIND00093549)
01r,16feb05,pmr  macrotized the 32-byte alignment used by device.
01q,26jan05,pmr  SPR 102537: make CFD_SIZE a multiple of cache line size.
01p,17may04,mdo  Add include file to fix compilation error when included in
                 the wrSbc405gp BSP
01o,26mar04,dlk  Fix incorrect usage of 'volatile' keyword.
01n,28jan04,wap  Add checksum offload support
...
#define FEI_LONG_WR(addr, value)                                        \
    (* (volatile UINT32 *) (addr) = ((UINT32) FEI_SWAP_LONG (value) ))
#endif /* FEI_LONG_WR */
 
#ifndef FEI_WORD_WR
#define FEI_WORD_WR(addr, value)                                        \
    (* (volatile UINT16 *) (addr) = ((UINT16) FEI_SWAP_WORD (value) ))
#endif /* FEI_WORD_WR */
...
#define FEI_LONG_RD(addr, value)                                        \
	...
	(value) = (UINT32) FEI_SWAP_LONG (_temp_);			\
	} while (0)
#endif /* FEI_LONG_RD */
...
#define FEI_WORD_RD(addr, value)                                        \
	...
	(value) = (UINT16) FEI_SWAP_WORD (_temp_);			\
	} while (0)
#endif /* FEI_WORD_RD */
...
#define FEI82550_DEVICE_ID	0x9999	/* 82550 pseudo device ID */
...
#define RFD_SIZE_HDR            16
        ...
        /* The RFD wants to be 32 byte aligned  so is rounded up to 32 */ 
#define RFD_SIZE_HDR            16
#define RFD_SIZE_EXTHDR         16
...
#define RFD_DESC_SIZE           DESC_ALIGN 
...
/*
 * Extended CFD offsets (present in 82550 and 82551 only). These
 * are used when we issue an IPCB transmit command, which gives us
 * extra fields that allow the use of TX checksum offload.
 */
#define CFD_SCHEDLO_OFFSET      0x10                    /* 16 bits */
#define CFD_IPSCHED_OFFSET      0x12                    /* 8 bits */
#define CFD_IPACTIVATEHI_OFFSET 0x13                    /* 8 bits */
#define CFD_VLAN_OFFSET         0x14                    /* 16 bits */
#define CFD_IPHDROFF_OFFSET     0x16                    /* 8 bits */
#define CFD_TCPUDPHDROFF_OFFSET 0x17                    /* 8 bits */
#define CFD_TBDZEROPTR_OFFSET   0x18                    /* 32 bits */
#define CFD_TBDZEROSIZE_OFFSET  0x1C                    /* 16 bits */
#define CFD_TOTALTCPLEN_OFFSET  0x1E                    /* 16 bits */
...
/* Extended RFD offsets (present in 82550 and 82551 only) */
#define RFD_VLANID_OFFSET       0x10                    /* VLAN ID (16 bits) */
#define RFD_RXPARSESTS_OFFSET   0x12                    /* 8 bits */
#define RFD_RSVD0_OFFSET        0x13                    /* 8 bits */
#define RFD_SECURITYSTS_OFFSET  0x14                    /* 16 bits */
#define RFD_CSUMSTS_OFFSET      0x16                    /* 8 bits */
#define RFD_ZEROCOPYSTS_OFFSET  0x17                    /* 8 bits */
#define RFD_PAD_OFFSET          0x18                    /* 64 bits */
...
#define CFD_TBD_OFFSET_TxCB     0x20
#define CFD_TBD_OFFSET_IPCB     0x20
#define CFD_FRAG1_OFFSET        CFD_TBD_OFFSET
#define CFD_FRAG1_OFFSET_TxCB   CFD_TBD_OFFSET
#define CFD_FRAG1_OFFSET_IPCB   0x18
...
#define IPCB_IP_CHECKSUM_ENABLE         0x10
#define IPCB_TCPUDP_CHECKSUM_ENABLE     0x20
#define IPCB_TCP_PACKET                 0x40
#define IPCB_LARGESEND_ENABLE           0x80
#define IPCB_HARDWAREPARSING_ENABLE     0x01
#define IPCB_INSERTVLAN_ENABLE          0x02
#define IPCB_IP_ACTIVATION_DEFAULT      IPCB_HARDWAREPARSING_ENABLE

#define IPCB_DEFAULT                    (/*IPCB_TCPUDP_CHECKSUM_ENABLE*/0 | \
                                         IPCB_IP_CHECKSUM_ENABLE | \
                                         (IPCB_HARDWAREPARSING_ENABLE << 8))

/*
 * We also need to save a pointer to the mBlk so we
 * can reap it later. We can place it after the TFD array.
 */
#define CFD_MBLK_OFFSET     CFD_TBD_OFFSET + (TBD_SIZE * (TBD_MAX_FRAGS + 2))
...
#define CFD_C_LOADFILT	0x0008
#define CFD_C_IPCBXMIT	0x0009		/* hardware offload transmit */
...
#define RFD_S_NOAMATCH	0x0004		/* doesn't match anything */
#define RFD_S_HWPARSE	0x0008		/* hardware parsed frame */
...
/*
 * Extended RFD definitions relating to TCP/IP checksum offload
 * (82550/82551 only)
 */

/* Bits in the 'csum' byte */
#define RFD_CS_TCPUDP_CHECKSUM_BIT_VALID        0x10
#define RFD_CS_TCPUDP_CHECKSUM_VALID            0x20
#define RFD_CS_IP_CHECKSUM_BIT_VALID            0x01
#define RFD_CS_IP_CHECKSUM_VALID                0x02

/* Bits in the 'packet parser' byte */
#define RFD_P_PARSE_BIT                         0x08
#define RFD_P_CHECKSUM_PROTOCOL_MASK            0x03
#define RFD_P_TCP_PACKET                        0x00
#define RFD_P_UDP_PACKET                        0x01
#define RFD_P_IP_PACKET                         0x03

typedef volatile UINT32 *	FD_ID;
typedef volatile UINT32 *	CSR_ID;
