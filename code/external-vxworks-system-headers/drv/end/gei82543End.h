...
/* Copyright 1990-2002, 2013 Wind River Systems, Inc. */
/*
modification history
--------------------
13dec13,xms  Support 82545 network card. (WIND00446795)
01l,11aug05,dlk  Add support for IPv6 checksum offload.
01k,04jun04,jln  add new flags: GEI_END_FORCE_FLUSH_CACHE and 
                 GEI_END_FORCE_INVALIDATE_CACHE
01j,08may04,dlk  Remove txType field from TX_DESCTL.
                 Remove DEFAULT_MBLK_NUM_FACTOR, must be same as
		 DEFAULT_LOAN_RXBUF_FACTOR for linkBuf/netTupleGet use.
01i,02feb04,wap  Add checksum offload support
01h,19dec02,jln add PHY BSP call hook for 82543-copper (SPR 84779)
...
#define TXDESC_CTX_STATUS_OFFSET        12  /* Status nybble byte offset */
...
#define PRO1000_545_BOARD				0x1026 /* 82545 GM MAC */
...
#define RCTL_SECRC_BIT			0x04000000
...
#define RXCSUM_IPV6OFL_BIT              0x0400
