...
/* Copyright 1986-2005, 2010 Wind River Systems Inc. */

/*
modification history
--------------------
01d,29apr10,pad  Moved extern C statement after include statements.
01c,11may05,j_b  add return value to CREATE_CRITSECT (SPR# 107058)
...
#define CREATE_CRITSECT(s)             (s = semMCreate(SEM_Q_FIFO)) 
