...
--------------------
01p,04dec10,pad  Replaced FUNCPTR with fully-qualified function pointer in
                 dllEach()'s signature.
01o,28apr10,pad  Moved extern C statement after include statements.
01n,26jan09,pcs  Updated to add support for LP64 data model.
01m,24jul06,jpb  Removal of duplicate definition of DL_LIST and DL_NODE.
01l,26jan06,mil  Updated for POSIX namespace conformance (P2).
01k,03jun05,yvp  Added #ifndef	_ASMLANGUAGE. 
                 Updated copyright. #include now with angle-brackets.
01j,19jan05,vvv  moved some macros here from osdep.h
01i,05may04,cjj  removed non-standard prototypes.
...
inline DL_NODE * dllEach
    ...
    return dllEach (pList,
		    (BOOL (*)(DL_NODE * pNode, _Vx_usr_arg_t arg))routine,
		    routineArg);
    }
#endif /* __cplusplus */
