...
/* Copyright 2005-2006, 2008-2011, 2014 Wind River Systems, Inc. */

/*
modification history
--------------------
08jul14,d_l added EIOCGPOLLSTATE. (VXW6-80632)
01o,06jul11,jjk  Support for Wake-On-Lan capabilities.
01n,07apr11,tlu  Added EIOCGTPID and EIOCSTPID
01m,13dec10,rme  Added EIOCSFWPORT
01l,28jun10,tlu  Added EIOCSVLANFILTER, EIOCSVIDFILTER, and EIOCCVIDFILTER
01k,28apr10,pad  Moved extern C statement after include statements.
01j,09sep09,dlk  Added EIOCGFWPORT.
01i,22mar08,dlk  MUX2 redesign. 1st checkin.
01h,07dec06,wap  Add jumbo frame support
01g,28apr06,dtr  SPR#120464 increase max end name size.
01f,07feb06,rb   Added IOCTLs for VLAN management
01e,29aug05,dlk  Move END_RCVJOBQ_INFO definition into end.h, as it is
		 not usable from user space.
01d,12aug05,dlk  Removed IPv6 checksumming capabilities bits. Use the
		 (previously) IPv4-only capabilities for both IPv4 and IPv6.
01c,26jul05,dlk  Added EIOCGRCVJOBQ. Recoded IFMEDIA ioctls to use structure
...
01b,24jun05,wap  Add ifmedia support
01a,21feb05,dlk  Extracted from end.h. Corrected ioctl codes.
*/
