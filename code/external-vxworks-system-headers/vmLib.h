...
/*
 * Copyright (c) 1984-2005, 2007, 2009-2010, 2014 Wind River Systems, Inc.
 *
...
--------------------
02s,15may14,jb   VXW6-81787 - add Intel Write Combining Option
02r,05nov10,zl   add deprecation warning to vmPhysTranslate(), removed it
                 from 64-bit.
02q,29apr10,pad  Moved extern C statement after include statements.
02p,25aug09,zl   added vmPageUnmap() declaration.
02o,21apr09,zl   LP64 updates. Replaced msize_t with size_t.
02n,20jul07,j_b  re-assign VM_STATE_BUFFERABLE for ARMARCH6
02m,02may07,zl   introduced msize_t.
02l,06mar07,pcs  Add prototype for vmPageMap.
02k,11aug05,zl   move init routines to future non-public section.
02j,07jul05,zl   added no-alias error codes.
