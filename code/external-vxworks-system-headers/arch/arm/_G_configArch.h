/* _G_config.h - autogenerated on Tue Feb  3 10:11:41 PST 1998*/

/* There may be a few (VxWorks related) differences between this file and the
 * corresponding one in host/$WIND_HOST_TYPE/arm-wrs-vxworks/include
*/
...
#else
typedef long long _G_llong;
typedef unsigned long long _G_ullong;
#endif
#else
