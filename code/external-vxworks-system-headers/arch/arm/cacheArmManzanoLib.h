/* cacheArmManzanoLib.h - ARM XScale cache library header file */
...
--------------------
01i,22feb06,m_h  Manzano Support
...
#ifndef	__INCcacheArmManzanoLibh
#define	__INCcacheArmManzanoLibh
...
IMPORT void	cacheArmManzanoLibInstall (VIRT_ADDR(physToVirt) (PHYS_ADDR),
                                          PHYS_ADDR(virtToPhys) (VIRT_ADDR));


/* definitions to allow for non-cacheAim direct calls */

#define cacheArmManzanoDClearDisable cacheAimManzanoDClearDisable
#define cacheArmManzanoIClearDisable cacheAimManzanoIClearDisable

IMPORT void	cacheAimManzanoDClearDisable (void);
IMPORT void	cacheAimManzanoIClearDisable (void);
...
#endif	/* __INCcacheArmManzanoLibh */
