...
/*
 * Copyright 1994-1998, 2000-2004, 2006-2007, 2010-2012 Wind River Systems, Inc.
 *
...
--------------------
01q,09apr13,d_l  fixed build warnings. (WIND00358283)
01p,16nov12,pcs  Add support for e6500
01o,25oct11,kab  Fix integer conversion warnings
01n,14sep11,syt  added support for PPC465.
01m,01mar11,x_z  added support for PPC476 and fixed support for MPC85XX.
01l,29jul10,pad  Moved extern C statement after include statements.
01k,18jul07,pch  CQ87449: blrl & bctrl are function calls; renumber from 19feb03
01j,26jun07,tbu  Added 64 bit support
	   +p_b  completed support
01i,17jan06,mmi  Add dsmFindByName() and dsmFindByInst() prototypes
01h,19oct04,to   fix SPR#75831
01g,18dec03,elg  Add definition of sc instruction.
01f,19feb03,x_p  Fix host build
01e,08oct03,mil  Fixed typo for _ESOP on host.
01d,16jun03,mil  Added E500 instructions.
...
/* cache instructions with CT field for PPC85XX and PPC476 */
