...
--------------------
01m,26mar12,cww  Added dsisr bits 1 and 4
01l,16jul07,pch  CQ86377: re-enable MSR[FP] for syscall handler if enabled in
		 caller
01k,29jun07,pch  CQ96747: add RI to _PPC_MSR_MMU_EXTRACT macro
01j,01jun06,pch  consolidate vector offset definitions in excPpcLib.h
01i,24jan05,mmi  Add _CPU_CACHE_ALIGN_SHIFT
01h,12feb04,jtp  Add _WRS_MMU_CLASS_* macro
01g,05dec03,jtp  Add _WRS_TLB_MISS_CLASS_HW, _PPC_MSR_MMU_EXTRACT
01f,13mar03,pch  Add PPC32 support
...
/* MMU uses PID registers to extend virtual address */
...
#define _CPU_CACHE_ALIGN_SHIFT   4      /* All ppc8xx have 16 bytes cache or less */
