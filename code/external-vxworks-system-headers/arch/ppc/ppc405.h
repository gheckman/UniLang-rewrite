...
/*
 * Copyright (c) 1984-2007, 2012 Wind River Systems, Inc.
 *
...
--------------------
01t,12apr12,cww  use common ESR definitions
01s,16jul07,pch  CQ86377: re-enable MSR[FP] for syscall handler if enabled in
		 caller
01r,29jun07,pch  CQ96747: rename _PPC_MSR_MMU_EXTRACT macro
01q,06jul06,pch  add MSR bit definitions & use in INT_MASK
01p,01nov04,pch  SPR 83004: move SPRG[4-7] definitions from asmPpc.h to ppc405.h
01o,24sep04,pch  add _PPC_MSR_DWE
01n,12feb04,jtp  Add _WRS_MMU_CLASS_* macro
01m,05dec03,jtp  Add _WRS_TLB_MISS_CLASS_HW, _PPC_MSR_MMU_EXTRACT
01l,29oct03,jtp  SPR 77774: Support Writethru cache
01k,23oct03,pch  SPR 80911: get PPC4xx cache dimensions from PVR
01j,13mar03,pch  Add PPC32 support & fix SPR 83162
...
#define	_PPC_MSR_BIT_AP		6
#define	_PPC_MSR_BIT_APE	12
...
#define _PPC_MSR_MMU_RI_EXTRACT(src, dst) \
	rlwinm	dst, src, 0, _PPC_MSR_BIT_IR, _PPC_MSR_BIT_DR
...
#define	_PPC405_DCWR_DEFAULT_VAL	0x00000000 /* def. data writethru */

#undef	_CPU_CACHE_ALIGN_SIZE
#define _CPU_CACHE_ALIGN_SIZE	32  /* all 405 cores have 32-byte cache lines */

#define	_PPC405_ICACHE_NWAYS	2   /* all 405 cores have 2-way Icache */
#define	_PPC405_DCACHE_NWAYS	2   /* all 405 cores have 2-way Dcache */
...
#define _PPC405_ESR_MCI	0x80000000  /* instr machine check occurred */
#define _PPC405_ESR_PIL	0x08000000  /* program exception - illegal */
#define _PPC405_ESR_PPR	0x04000000  /* program exception - previledged */
#define _PPC405_ESR_PTR	0x02000000  /* program exception - trap */
...
#define _PPC_ESR_MCI	_PPC405_ESR_MCI
#define _PPC_ESR_PIL	_PPC405_ESR_PIL
#define _PPC_ESR_PPR	_PPC405_ESR_PPR
#define _PPC_ESR_PTR	_PPC405_ESR_PTR
#define _PPC_ESR_DST	_PPC405_ESR_DST
#define _PPC_ESR_DIZ	_PPC405_ESR_DIZ
#define _PPC_ESR_PFP	_PPC405_ESR_PFP
#define _PPC_ESR_U0F	_PPC405_ESR_U0F
