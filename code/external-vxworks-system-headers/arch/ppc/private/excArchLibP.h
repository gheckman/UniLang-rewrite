...
--------------------
01i,01mar13,h_k  added T4_ERRATUM_CPU6198 for e6500.
01h,18nov09,to   GUEST: _VB_PISA_EHV support
01g,12may09,rec  move guestOs ENT_OFF definition here
01f,23may08,pch  CQ118100: clean up SMP support in critical-exception handling
01e,17oct05,pch  SPR 113899: exc/intConnectCode must restore 32-bit mode
                 before calling exc/intEnt
01d,22sep04,pch  Add debug/trace capabilities (under #ifdef)
01c,06aug04,pch  SPR's 78780 & 100398: support use of standard exception 
		 vectors in MMU and syscall
01b,05may04,pch  SPR 92997: use correct symbol name in multiple-include
                 protection
01a,08Dec03,pch  extracted from excArchLib.c vn 02z
*/
...
#if	defined(_EXC_OFF_CRTL) || defined(_WRS_PPC_64BIT)
