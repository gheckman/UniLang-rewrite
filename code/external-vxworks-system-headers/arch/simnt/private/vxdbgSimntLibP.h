/* vxdbgSimsolarisLibP.h - private simsolaris VxDBG library header file */
...
#ifndef __INCvxdbgSimsolarisLibPh
#define __INCvxdbgSimsolarisLibPh
...
#define VXDBG_INT_LOCK_LEVEL_COMPUTE(level, value)	\
		((level & ~SIM_STATUS_INTLOCK) | (value & SIM_STATUS_INTLOCK))

#ifdef	_WRS_CONFIG_SMP

/* return TRUE if interrupts are locked in specified register set. */

#define	VXDBG_INT_REGS_IS_LOCKED(pRegs)	VXSIM_INT_MASK_GET (pRegs->reg_status)
...
#endif	/* __INCvxdbgSimsolarisLibPh */
