...
/* Copyright 1992-1993,2001-2002,2008,2010-2011 Wind River Systems, Inc. */

/*
modification history
--------------------
01m,22dec11,jjk  WIND00313302 - Fix display of FP/MMX registers
01l,27jul11,g_x  add xmm[] and ymm[] to FPREG_SET (WIND00285122)
01k,22mar11,ggm  WIND00262870 - Added fppArchCpuInit.
01j,19jan11,ggm  XSave/XRestore implementation for extended state context
                 switch.
01i,29sep10,scm  adjust offset for FPXREG_FPX for DOUBLEX_SSE structs...
01h,05mar08,scm  WIND00116608.
...
/* FPREGO_SET - FP register set that is different from FP_CONTEXT */
...
typedef struct fpregSet
    ...
    union n
	{
	FPREGO_SET o;			/* old FPO_CONTEXT for fsave/frstor */
	FPREGX_SET x;			/* new FPX_CONTEXT for fxsave/fxrstor */
	FPREGX_EXT_SET  x_ext;         /* FPX_EXT_CONTEXT for xsave/xrstor  */ 
	} n;
    } FPREG_SET;
