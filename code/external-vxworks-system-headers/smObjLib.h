...
/* 
 * Copyright 1992-1994, 2002-2003, 2008-2010 Wind River Systems, Inc. 
 *
...
01o,25aug09,jpb  Updated for LP64 support.
01n,25jun08,cwu  add macro "S_smObjLib_NOT_SM_MASTER" to enable more exceptional 
                 information with errno
01m,21nov03,dat  adding objLib.h
...
#define S_smObjLib_NOT_SM_MASTER          (M_smObjLib | 8)

#define SM_OBJ_MAX_CPU		20      /* absolute maximum number of CPU */

/* useful shared memory object ids handling macros */

#define ID_IS_LOCAL(id)		((((ULONG) id) & 1) == 0)
#define ID_IS_SHARED(id)	((((ULONG) id) & 1) != 0)
#define SM_OBJ_ID_TO_ADRS(id)	(((long)(id)) + smObjPoolMinusOne)
#define SM_OBJ_ADRS_TO_ID(adrs)	(((long)(adrs)) - smObjPoolMinusOne)

/* local to global and global to local address conversion; local NULL pointer */

#define GLOB_TO_LOC_ADRS(adrs)	(((long)(adrs)) + localToGlobalOffset)
#define LOC_TO_GLOB_ADRS(adrs)	(((long)(adrs)) - localToGlobalOffset)
